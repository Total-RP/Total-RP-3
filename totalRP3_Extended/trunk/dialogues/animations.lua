...
function TRP3_API.extended.animations.playAnimationDelay(model, sequence, duration, delay, token)
	if delay == 0 then
...
TRP3_API.extended.animations.getDuration = getDuration;
...
function TRP3_API.extended.animations.getAnimationByModel(model, animationType)
	if model then
...
TRP3_API.extended.animations.SCALE_MAPPING = {
