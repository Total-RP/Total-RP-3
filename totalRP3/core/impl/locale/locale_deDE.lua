...
Diese Option is besonders auf PvP Realms nützlich, auf denen Spieler der anderen Fraktion das System ausnutzen können um dich zu verfolgen.]=],
            CO_MAP_BUTTON = "Kartenscan Schaltfläche",
            CO_MAP_BUTTON_POS = "Scanschaltflächen-Verankerung auf der Karte", -- Needs review
...
Bist du sicher, dass du dir das Profil ansehen willst?]=],
            ...
            MORE_MODULES_1 = [=[h2:c}Optionale Module{/h2}
{h3}TipTac Module{/h3}
Das |cff9999ffTipTac Modul|r fügt die Kompatibilität mit dem TipTac Add-on zu Total RP 3hinzu, so dass Total RP 3 Tooltips deinen TipTac Skin verwenden und so verankert werden wie du es in TipTac eingestellt hast.

|cff9999ff{link*http://mods.curse.com/addons/wow/total-rp-3-tiptac-module*Auf Curse.com herunterladen}.]=],
...
Diese Nachricht wird nur einmal pro Sitzung angezeigt und kann in den Einstellungen (Allgemeine Einstellungen => Verschiedenes) abgeschaltet werden.]=], -- Needs review
...
Benutze die |cffffff00Profil importieren|r Option um Daten aus einem früheren Export in ein existierendes Profil einzufügen. Die existierenden Daten des Profils werden durch das die neu eingefügten ersetzt. Du kannst die Daten nicht direkt in das derzeit ausgewählte Profil importieren.]=], -- Needs review
            PR_EXPORT_IMPORT_TITLE = "Profil exportieren/importieren",
            PR_EXPORT_NAME = "Text für Profil %s (Größe %0.2f kB)", -- Needs review
...
Max: 20 kB]=],
            ...
            PR_IMPORT_PROFILE_TT = "Hier einen Profiltext einfügen", -- Needs review
...
Den gesamten Inhalt des Profils %s mit den importierten Daten überschreiben?]=], -- Needs review
            ...
            REG_COMPANION_BOUNDS = "Bindungen", -- Needs review
...
Diese Tools erlauben dir auch das Einfügen von |cffffff00Bildern, Icons oder Links zu externen Internetseiten|r.]=], -- Needs review
            ...
            REG_COMPANION_TARGET_NO = "Dein Ziel ist kein gültiges Haustier, Minion, Ghul, Magierlementar oder umbenanntes Kampfhaustier.", -- Needs review
            ...
            REG_COMPANION_UNBOUND = "Entbinden von ...", -- Needs review
...
|cffffff00Drag & drop:|r Slots neu anordnen]=],
            ...
            REG_PLAYER_GLANCE_PRESET_ADD = "Vorlage |cff00ff00%s|r erstellt.", -- Needs review
...
Bitte gib einen Kategoriennamen für diese Vorlage ein.]=],
            ...
            REG_PLAYER_GLANCE_PRESET_REMOVE = "Vorlage |cff00ff00%s|r entfernt", -- Needs review
...
|cffffff00Klicke, um mögliche Aktionen zu wählen]=], -- Needs review
            ...
            SCRIPT_UNKNOWN_EFFECT = "Scriptfehler, unbekannte FX", -- Needs review
            TB_AFK_MODE = "AFK",
...
Diese Version führt einige nette neue Funktionen und Verbesserungen ein.

## Filter für Profile mit Erwachseneninhalten

Wir haben ein Filtersystem für Profile mit Erwachseneninhalten zu Total RP3 hinzugefügt. Diese Funktion ist standardmäßig aktiviert, wenn der Schimpfwortfilter oder die elterliche Kontrolle eingeschaltet ist. Du kannst dies jederzeit in den Optionen in der Register/Verzeichniseinstellung an- und abschalten.

Wenn der Erwachseneninhaltsfilter angeschaltet ist, wird Total RP3 die Profile die du erhälst nach spezifischen Wörtern durchsuchen. Profile die als als Erwachseneninhalt markiert werden haben einen stummgeschalteten Tooltip, ihre "Auf den ersten Blick"-Leiste wird nicht angezeigt und du erhälst eine Warnmeldung, wenn du das Profil öffnen willst.

Du kannst diese Warnung ignorieren und das Profil ansehen oder das Profil einer Whitelist hinzufügen, wenn du für dieses nicht mehr filtern möchtest.

Du kannst auch manuell Profile als Profile mit Erwachseneninhalt markieren. Wenn du dies tust kannst du das Wort angeben, welches nicht von Total RP 3 gefiltert wurde, so dass es zum Filter hinzugefügt wird und dieser so in Zukunft klüger beim markieren von Profilen ist.

Der Filter für Erwachseneninhalte enthält bereits einige Wörter in Englisch, Spanisch und Französisch. Du kannst das Wörterbuch in den Einstellungen bearbeiten und Wörter hinzufügen und entfernen.

## Profile exportieren und importieren

Du kannst jetzt Profildaten als kopierbaren Text exportieren und an anderen Stellen einfügen. Diesen Text kannst du dann in ein anderes Profil wieder einfügen. Die exportierten Daten enthalten all deine Profilinformationen, deine Verhältnisse und in Zukunft auch dein Inventar und Questlog.


## Verbesserungen

* Das UI wurde an diversen stellen verbessert.
* Das Kartenstandortsystem wurde angepasst um einen Fehler zu verhindern wenn die Karte geöffnet wird.
* Es wurde ein Fehler mit dem Begleitersystem behoben der auftrat, wenn der Farbenblindheitsmodus eingeschaltet ist.
* Kleine Textkorrekturen™]=], -- Needs review
    }
};
