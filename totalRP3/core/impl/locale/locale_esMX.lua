...
Esta opción es útil en los reinos JcJ donde los jugadores de la facción contraria pueden usar este sistema para localizarte.]=],
        CO_MAP_BUTTON = "Botón de escaneo en el mapa",
        CO_MAP_BUTTON_POS = "Botón de escaneo anclado en el mapa",
...
Todas tus acciones serán interpretadas como si tu personaje las realizara.]=],
        ...
        DB_STATUS_RP_OOC_TT = [=[Estás fuera de personaje.
Tus acciones no se asociarán a los de él/ella.]=],
...
|cff00ff00Esta información se colocará en la descripción de tu personaje.]=],
        ...
        MAP_BUTTON_TITLE = "Rastreo de rol",
...
|cffffff00Haz clic para mostrar las acciones posibles]=],
        ...
        TB_GO_TO_MODE = "Camtiar a %s",
        TB_LANGUAGE = "Idioma",
        TB_LANGUAGES_TT = "Cambiar idioma",
        TB_NORMAL_MODE = "Normal",
        TB_RPSTATUS_OFF = "Personaje: |cffff0000Fuera de personaje",
...
Total RP no es responsable de los enlaces que conducen a contenidos nocivos.]=],
        ...
        WHATS_NEW_4 = [=[# Novedades en la versión 1.2.1

## La tirada de dados

¡La tirada de dados del TRP2 está de vuelta! Utiliza el comando |cff00ff00/trp3 roll|r para tirar un dado 1d100. También puedes tirar varios dados a la vez indicando el número y tipo de dados. Cualquier tirada que realices se compartirá por grupo/banda/objetivo si tienes el TRP3 1.2.1.
...
Esta versión introduce un par de nuevas características y mejoras.

## Sistema de filtro de perfiles adultos

Hemos añadido un nuevo sistema de filtro de de perfiles adultos a Total RP 3. Esta característica se habilita por defecto si se habilita la opción de filtro de profanidad o si el control parental está activado. Siempre puedes habilitar o deshabilitar esta opción en las herramientas de registro.

Cuando el filtro adulto está activo, Total RP 3 revisará el contenido de los perfiles que recibas en busca de palabras específicas adultas. Los perfiles marcados como adultos tendrán su información oculta, así como tampoco se verá su barra de A primera vista y recibirás un aviso cuando desees abrir el perfil.

Puedes ignorar la alerta y consultar el perfil o añadir el perfil a la lista blanca si no quieres que vuelva a ser filtrado.

Puedes marcar manualmente un perfil como adulto. Haciéndolo podrás añadir palabras no filtradas por Total RP 3 para que sean añadidas al filtro y facilitar su labor a la hora de marcar perfiles.

El diccionario del filtro adulto ha sido creado con algunas palabras para los idiomas inglés, español y francés. Puedes editar el diccionario para añadir o eliminar palabras.

## Exportar e importar perfiles

Ahora puedes exportar la información de perfiles en texto para copiarlo y pegarlo en otro lugar. Podrás volver a pegar la información en el perfil. La información exportada contiene toda la información de tu perfil, tus relaciones y en el futuro contendrá tu inventario y tu registro de misiones.

## Mejoras

* Hemos refinado la interfaz en algunos sitios.
* El sistema de localización del mapa se ha mejorado para prevenir problemas al abrir el mapa.
* Se ha arreglado un problema con el sistema de compañeros cuando se habilitaba el modo daltónico.
* Arreglados textos menores™]=],
    }
