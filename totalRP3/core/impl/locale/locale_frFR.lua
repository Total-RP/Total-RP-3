...
{h3}Module TipTac{/h3}
Le |cff9999ffmodule TipTac|r ajoute une compatibilité avec l'add-on TipTac à Total RP 3 pour que les infobulles aient l'apparence de TipTac et soient ancrées correctement.
{link*http://mods.curse.com/addons/wow/total-rp-3-tiptac-module* Télécharger sur Curse.com}.
