...
- Pour Ellypse: Les guildes Maison Celwë'Belore, Mercenaires Atal'ai, et plus particulièrement Erzan, Elenna, Caleb, Siana and Adaeria
...
|cffff0000Ce protocol de communication n'est pas compatible avec les versions précédentes de Total RP 3|r, il est donc normal de ne pas recevoir les profils des joueurs utilisant une ancienne version, dites leur de mettre à jour leur add-on. S'ils restent sur une vieille version ils seront isolés du reste de la communauté.

|cff9999ffNote: Notre implémentation du Mary Sue Protocol n'est pas impacté par ce changement.|r

{h3}Améliorations{/h3}
Nous avons ajouté plusieurs nouvelles options aux {link*tooltip_settings*réglages de l'infobulle} (toutes sont désactivées par défaut, il faudra les activer).

On peut maintenant:
• Cacher les infobulles de Total RP 3 lorsque l'on est HRP.
