...
|cff9999ffTotal RP 3: Extended|r añade la posibilidad de crear nuevo contenido en WoW: campañas con misiones y diálogos, objetos, documentos (libros, carteles, contratos…) ¡Y mucho más!
{link*http://extended.totalrp3.info*Descarga en Curse.com}
...
Total RP no es responsable de los enlaces que conducen a contenidos nocivos.]=],
        ...
        WHATS_NEW_5 = [=[# Novedades en la versión 1.2.3

## Mejoras en las funciones de rastreo de mapa

Hemos solucionado los problemas producidos por el parche 7.1 con los marcadores del mapa. Con el fin de mejorar la compatibilidad con los otros complementos que muestras información adicional en el mapa, el botón de rastreo ha sido eliminado y ahora se encuentra incluido en las opciones de buscador situado en la parte superior derecha del mapa.

## Protocolo de difución mejorado

Hemos actualizado nuestro protocolo de difusión para usar un método que consuma menos ancho de banda. La otra ventaja es que estos métodos estarán disponibles para las cuentas de prueba, es decir, ahora los usuarios que jueguen en una cuenta de prueba serán capaces de consultar la ubicación de la gente en el mapa y recibir sonidos de los objetos del Total RP 3: Extended.

También hemos añadido una protección y monitoreo adicional contra las personas que tratan de evitar la entrada al canal de difusión `xtensionxtooltip2` mediante contraseñas de canal.

## Otras mejoras

- Se ha corregido un error producido en la versión 1.2 que estaba haciendo que las fichas de perfiles importadas no se mostrasen correctamente. ¡Gracias a Gordon8 y a Gelaga por informar de este error!
- Total RP 3: Extended se ha añadido a la lista de módulos opcionales en la pestaña de Módulos en ajustes.

# Novedades en la versión 1.2.2

Esta versión corrige un gran problema de rendimiento con la trasferencia de datos del TRP desde el 1.1.0. |cff00ff00It Debería estar mejorando a medida que más personas van actualizando el TRP3 a esta versión. ¡Así que corre la voz!]=],
    }
};
