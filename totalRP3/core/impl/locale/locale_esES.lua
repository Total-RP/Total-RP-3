...
|cffff9900Hay un error en WoW que pierde toda la información guardada al llegar a cierto límite. Recomendamos encarecidamente evitar deshabilitar el sistema de purga.]=],
            ...
            CO_TOOLTIP = "Ajustes de herramientas",
...
|cff00ff00%s]=],
            ...
            REG_LIST_CHAR_TT_CHAR = "Personaje(ss de WoW ligado(s):",
...
Total RP no es responsable de los enlaces que conducen a contenidos nocivos.]=],
            ...
            WHATS_NEW_2 = [=[{h3:c}Novedades en la versión {col:6eff51}1.1.2{/col}{/h3}

{h3}Arreglado el exploit en la alerta de actualización{/h3}
Cuando haya una nueva actualización para TRP3:
• Tu addon esperará a recibir una notificación de al menos 15 jugadores distintos antes de avisarte.
• La alerta ahora se muestra en la ventana principal de TRP3 y no en una ventana pop-up.

{h3:c}Nuevo en la versión {col:6eff51}1.1.0{/col}{/h3}

{h3}Nuevo sistema de comunicación{/h3}
Esta versión trae un nuevo TRP3 que el sistema de comunicación del TRP3 necesitaba para {link*https://www.kickstarter.com/projects/119053864/total-rp-3-extended-world-of-warcraft-addon*Total RP 3: Extended} y Legion que es más fuerte y mejorará el intercambio de una gran cantidad de información.

|cffff0000Este sistema de comunicación no es compatible con versiones previas de Total RP 3|r, así que no te asustes si no recibes ningún perfil de previas versiones, simplemente avisa a la gente para que actualice. Si siguen usando una versión antigua, quedarán aislados del resto de la comunidad Total RP.

|cff9999ffNota: La implementación de nuestro Protocolo Mary Sue Protocol no se verá afectada por esto.|r

{h3}Mejoras{/h3}
Hemos añadido un montón de nuevas opciones para la {link*tooltip_settings*configuración de herramientas} (todas están desctivadas por defecto, tendrás que activarlas (como los campers de Villadorada, si sabes a qué me refiero...)).

Ahora puedes:
• Ocultar información personalizada de RP cuando estés fuera de personaje.
• Deshabilitar colores personalizados en las herramientas si te parecen molestos.
• Aumentar dinámicamente la proporción del color de contraste para el texto en las herramientas. Habilitar esta opción permitirá a Total RP 3 modificar los colores personalizados definidos por otros jugadores para hacer el texto más legible si el color es demasiado oscuro.

{h3}|cffff0000Características eliminadas|r{/h3}
Tuvimos que eliminar los botones de herramientas para mostrar y ocultar casco y capa ya que Blizzard ha eliminado esta opción en Legion. Las funciones API usadas por Total RP 3 ya no están presentes en el juego, por lo que ahora tendrás que ir a un PNJ de transfiguración para ocultar tu capa o tu yelmo.]=],
    }
