...
Essa mensagem só irá aparecer uma vez por sessão e pode ser desativada nas opções.]=],
        ...
        MORE_MODULES = [=[{h2:c}Módulos opcionais{/h2}
{h3}Storyline{/h3}
|cff9999ffStoryline|r é um módulo que melhora os textos de missão originais do WoW e aperfeiçoa a imersão através de diálogos animados e efeitos elaborados.
|cff9999ffPor favor visite: {link*storyline*http://storyline.totalrp3.info}]=], -- Needs review
...
{col:ffffff}Obrigado a todos nossos amigos pelo seu suporte por todos esses anos:{/col}
- Para Telkos: Kharess, Kathryl, Marud, Solona, Stretcher, Lisma...
- Para Ellypse: As guildas Maison Celwë'Belore, Mercenaires Atal'ai, e mais particularmente Erzan, Elenna, Caleb, Siana e Adaeria
...
{col:ffffff}Por nos enviar a revista Gamer Culte Online #14 com um artigo sobre o Total RP:{/col}
