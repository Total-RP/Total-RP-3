...
local LOCALE_EN = {
	...
	localeContent = {
		...
		REG_PLAYER_NAMESTITLES = "Name and titles",
		REG_PLAYER_EDIT_NAME = "Edit information",
		...
		REG_PLAYER_STYLE = "Roleplay style",
		...
		REG_PLAYER_PSYCHO_ADD = "Add a new personality trait",
		...
		REG_PLAYER_PSYCHO_Modeste = "Modest";
		REG_PLAYER_PSYCHO_Modeste_TT = "|cff00ffff\"Don't mention it. It's natural. You would have done the same.\"|rThat's what they'd tell a family after saving their lives.\nThey don't derive any personal glory from feats of arms or services rendered.\nThey don't feel the need to advertise every good deed they perform. They can even be uncomfortable when other people mention their altruism and bravery.";
		REG_PLAYER_PSYCHO_Vantard = "Bragger";
		REG_PLAYER_PSYCHO_Vantard_TT = "Whenever they accomplish anything, the whole town hears about it for weeks.\nEven small things like changing socks (well, that's no small thing to them) or spelling their own names, all of that will be broadcast widely.\nOne of their favourite quotes is |cff00ffff\"Oh but I know a few things you don't\"|r, which they say while puffing up their chest with importance.\nMost of the time, nobody listens. But they don't mind. They like the sound of their own voices.";
		REG_PLAYER_PSYCHO_Pieux = "Pious";
		...
		REG_PLAYER_MISC_ADD = "Add a new custom field",
		...
		PR_PROFILE_HELP = "A profile contains all information about a \"character\" as a roleplay character : description, inventory, quest log, states ...etc.\n\nA real Wow character can be bound to only one profile at a time, but can switch from one to another whenever you want.\n\nYou can also bound several Wow characters to the same profile !",
		PR_PROFILE_DETAIL = "This profile is currently bound to these characters",
		PR_DEFAULT_PROFILE = "Default profile",
		PR_DELETE_PROFILE = "Delete profile",
		PR_DUPPLICATE_PROFILE = "Duplicate profile",
		PR_DEFAULT_PROFILE_HINTE = "This profile is read-only and cannot be deleted. Also you can't use most of TRP features if your character is bound to this profile. This profile is made for non-TRP characters.",
