...
Cambiar este nombre no afectará al vinculo entre este perfil y tus personajes.]=],
		...
		REG_COMPANION_BOUNDS = "Ligar",
		REG_COMPANION_BOUND_TO = "Ligar a...",
		...
		REG_COMPANION_LINKED = "El compañero %s está ligado al perfil %s.",
...
Esta herramienta también permite insertar |cffffff00imagenes, iconos o links externos de sitios web|r.]=],
		...
		REG_COMPANION_TARGET_NO = "Tú objetivo no es una mascota, necrófago, elemental de mago o compañero renombrado válido.",
		...
		REG_COMPANION_UNBOUND = "Desligar...",
...
|cffffff00Arrastrar y soltar:|r mover ranura]=],
		...
		REG_PLAYER_GLANCE_PRESET_ADD = "Creado preestablecido |cff00ff00%s|r.",
...
|cffffff00Clic-derecho:|r Parar tema]=],
		...
		UI_COMPANION_BROWSER_HELP_TT = [=[|cffffff00Advertencia: |rSólo los compañeros renombrados pueden ligarse a un perfil..

|cff00ff00Esta sección solo muestra esos compañeros.]=],
		UI_FILTER = "Filtro",
