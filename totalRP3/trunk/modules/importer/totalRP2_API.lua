...
-- TODO Import functions used in Total RP 2
local API = {};

-- TODO Import location from Total RP 2
local loc = {
...
-- TODO return a profile, formated for Total RP 2, corresponding to the given ID
...
-- TODO Return list Id -> String for each profiles to display in the list
