...
TRP3_BACKDROP_COLOR_GOLD = TRP3.CreateColor(1, 0.675, 0.125);
TRP3_BACKDROP_COLOR_GREY = TRP3.CreateColor(0.6, 0.6, 0.6);
TRP3_BACKDROP_COLOR_CREAMY_BROWN = TRP3.CreateColor(0.48, 0.39, 0.32);
