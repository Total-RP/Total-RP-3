...
L = {
	...
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_HELP"] = "要穿戴的装备方案的名字必须和一个在角色信息页面的装备管理器中存储的装备方案完全一致。",
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_INVALID"] = "切换装备方案失败：方案%s不存在。",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST"] = "开关位置广播",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_DESCRIPTION"] = "开关是否将你显示在其他人的地图搜索上。",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_DISABLED"] = "地图扫描位置广播已关闭。",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_ENABLED"] = "地图扫描位置广播已开启。",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_ERROR"] = "地图扫描位置广播状态切换失败。",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE"] = "开关自定义姓名板",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_DESCRIPTION"] = "切换是否使用自定义姓名板。",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_DISABLED"] = "自定义姓名板已关闭。",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_ENABLED"] = "自定义姓名板已开启。",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_ERROR"] = "切换自定义姓名板失败：%s",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS"] = "切换友善NPC姓名板",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_DESCRIPTION"] = "切换友善NPC的姓名板是否显示。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_DISABLED"] = "友善NPC姓名板已关闭。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_ENABLED"] = "友善NPC姓名板已开启。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_ERROR"] = "友善NPC姓名板切换失败：%s",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS"] = "切换友善玩家姓名板",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_DESCRIPTION"] = "切换是否显示其他友善玩家的姓名板。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_DISABLED"] = "友善玩家姓名板已关闭。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_ENABLED"] = "友善玩家姓名板已开启。",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_ERROR"] = "切换友善玩家姓名板失败：%s",
	["AUTOMATION_ACTION_OPTIONS_HELP"] = "宏的条件必须满足以下任意一项：%s",
	["AUTOMATION_ACTION_PROFILE_CHANGE"] = "切换方案",
	["AUTOMATION_ACTION_PROFILE_CHANGE_DESCRIPTION"] = "切换你当前选择的方案。",
	["AUTOMATION_ACTION_PROFILE_CHANGE_ERROR"] = "切换方案失败：%s",
	["AUTOMATION_ACTION_PROFILE_CHANGE_HELP"] = "以不区分大小写，模糊配对的方式切换到将要使用的方案。如果要使用精确配对，请将人物卡名字用引号\"\"包起来。",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS"] = "切换角色扮演状态",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_CHANGED_IC"] = "角色扮演状态切换为扮演中。",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_CHANGED_OOC"] = "角色扮演状态切换为OOC。",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_DESCRIPTION"] = "切换你当前的角色扮演状态（扮演中或OOC）。",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_ERROR"] = "角色扮演状态切换失败：%s",
	["AUTOMATION_CATEGORY_MAP_SCANS"] = "地图扫描",
	["AUTOMATION_CATEGORY_PROFILE"] = "人物卡",
	["AUTOMATION_CONDITION_ROLEPLAY_STATUS_ERROR"] = "检查角色扮演状态失败：%s",
	["AUTOMATION_ERROR_INVALID_OPTION"] = "选项'%1$s'无效（需要以下任意：%s）",
	["AUTOMATION_ERROR_INVALID_PROFILE"] = "找不到名为'%s'的人物卡",
	["AUTOMATION_MODULE_DESCRIPTION"] = "允许切换人物卡和角色扮演状态这样的动作自动进行。",
	["AUTOMATION_MODULE_NAME"] = "自动化",
	["AUTOMATION_MODULE_SETTINGS_HELP"] = "从以下菜单中选择一个动作，并在文本输入框中输入一个宏条件字串。",
	["AUTOMATION_MODULE_SETTINGS_TITLE"] = "自动化",
	["AUTOMATION_PROFILE_COPY"] = "复制方案",
	["AUTOMATION_PROFILE_COPY_DIALOG_BUTTON1"] = "复制",
	["AUTOMATION_PROFILE_COPY_DIALOG_TITLE"] = "是否确定将方案|W|cnGREEN_FONT_COLOR:%s|r|w中的全部自动化规则替换为|W|cnGREEN_FONT_COLOR:%s|r|w中的规则？",
	["AUTOMATION_PROFILE_COPY_HELP"] = "将这个方案中存储的所有规则复制到当前启用的方案。|n|n这将|cnRED_FONT_COLOR:不可逆转|r地替换当前方案中的规则。",
	["AUTOMATION_PROFILE_CREATE"] = "创建方案",
	["AUTOMATION_PROFILE_CREATE_DIALOG_BUTTON1"] = "创建",
	["AUTOMATION_PROFILE_CREATE_DIALOG_TITLE"] = "给新的自动化方案输入一个名字。",
	["AUTOMATION_PROFILE_CREATE_HELP"] = "创建一个新方案。|n|n方案可以被用于建立角色专属的人物卡自动化功能。",
	["AUTOMATION_PROFILE_DELETE"] = "删除方案",
	["AUTOMATION_PROFILE_DELETE_DIALOG_TITLE"] = "你是否要删除方案|W|cnGREEN_FONT_COLOR:%s|r|w？",
	["AUTOMATION_PROFILE_DELETE_HELP"] = "删除这个方案。|n|n这是一个|cnRED_FONT_COLOR:不可逆转|r的操作，删除的方案无法恢复。",
	["AUTOMATION_PROFILE_ENABLE"] = "启用方案",
	["AUTOMATION_PROFILE_ENABLE_HELP"] = "为当前角色启用该方案。",
	["AUTOMATION_PROFILE_RESET"] = "重置方案",
	["AUTOMATION_PROFILE_RESET_DIALOG_TITLE"] = "你确定要重置方案|W|cnGREEN_FONT_COLOR:%s|r|w中所有的自动化规则吗？",
	["AUTOMATION_PROFILE_RESET_HELP"] = "重置当前启用方案中所有存储的规则，这将|cnRED_FONT_COLOR:不可逆转地删除|r当前方案中的所有规则。",
	["AUTOMATION_STATE_IC"] = "扮演中",
	["AUTOMATION_STATE_OOC"] = "OOC",
	["AUTOMATION_STATE_UNSET"] = "无变化",
	["AUTOMATION_TEST_BUTTON"] = "测试条件",
	["AUTOMATION_TEST_HELP"] = "执行支持的宏条件，并把它将做出的选择发送到聊天框。",
	["AUTOMATION_TEST_OUTPUT"] = "测试条件结果：%s",
...
|cnGREEN_FONT_COLOR:注意:此功能在战斗中禁用。|r]=],
	...
	["CO_CUSTOMIZATION"] = "自定义",
	["CO_DATE_FORMAT"] = "日期格式",
	["CO_DATE_FORMAT_HELP"] = "插件中使用的日期/时间字串格式。|n|n如果留空，将根据当前插件使用的语言自动选择。|n|n支持以下格式：|n|n%1$s|n|n。所有角色将共享这一设置。",
	["CO_DATE_FORMAT_SPEC_a"] = "%1$s缩写的星期天数(%2$s)",
	["CO_DATE_FORMAT_SPEC_A"] = "%1$s全部的星期天数(%2$s)",
	["CO_DATE_FORMAT_SPEC_b"] = "%1$s: 缩写月份 (%2$s)",
	["CO_DATE_FORMAT_SPEC_B"] = "%1$s: 全称月份 (%2$s)",
	["CO_DATE_FORMAT_SPEC_d"] = "%1$s: 月内天数 (%2$s)",
	["CO_DATE_FORMAT_SPEC_ESC"] = "%1$s: 文字缩写 '%%'",
	["CO_DATE_FORMAT_SPEC_H"] = "%1$s: 24小时制 (%2$s)",
	["CO_DATE_FORMAT_SPEC_I"] = "%1$s: 12小时制 (%2$s)",
	["CO_DATE_FORMAT_SPEC_m"] = "%1$s: 月份 (%2$s)",
	["CO_DATE_FORMAT_SPEC_M"] = "%1$s: 分钟 (%2$s)",
	["CO_DATE_FORMAT_SPEC_p"] = "%1$s: AM或PM (%2$s)",
	["CO_DATE_FORMAT_SPEC_S"] = "%1$s: 秒 (%2$s)",
	["CO_DATE_FORMAT_SPEC_y"] = "%1$s: 两位数年份 (%2$s)",
	["CO_DATE_FORMAT_SPEC_Y"] = "%1$s: 完整年份 (%2$s)",
	["CO_GENERAL"] = "常规设置",
 ...
 如果选择不重新加载，界面语言将在下次登录时改变。]=],
	["CO_GENERAL_COM"] = " 交流",
	["CO_GENERAL_CONTRAST_LEVEL"] = "颜色对比度",
	["CO_GENERAL_CONTRAST_LEVEL_HELP"] = "控制自定义颜色基于背景的对比强度。|n|n推荐默认设置是“低”，它只会影响很暗的颜色。",
	["CO_GENERAL_CONTRAST_LEVEL_HIGH"] = "高",
	["CO_GENERAL_CONTRAST_LEVEL_LOW"] = "低",
	["CO_GENERAL_CONTRAST_LEVEL_MEDIUM_HIGH"] = "中高",
	["CO_GENERAL_CONTRAST_LEVEL_MEDIUM_LOW"] = "中低",
	["CO_GENERAL_CONTRAST_LEVEL_NONE"] = "无",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_HIGH"] = "很高",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_LOW"] = "很低",
	["CO_GENERAL_DEFAULT_COLOR_PICKER"] = "默认的颜色选择器",
	["CO_GENERAL_DEFAULT_COLOR_PICKER_TT"] = "激活总是使用默认的颜色选择器。如果你正在使用一个颜色选择插件，这是很有用的。",
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE"] = "关闭欢迎信息",
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE_HELP"] = "关闭登陆时聊天框的欢迎信息。",
...
这可以防止恶意玩家搜索并击杀你。]=],
	...
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER"] = "显示OOC玩家",
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER_TT"] = "如果启用，将地图上所有OOC状态的玩家标注出来。",
...
|cff00ff00 提醒:您可以使用 /trp3 switch main|r 打开trp3]=],
	...
	["CO_MODULES_SUPPORTS_HOTRELOAD"] = "这个模块支持快速重置。",
...
|cnWARNING_FONT_COLOR:但这有一个bug，当它到达某个特定的值时，它会丢失所有被保存的数据。我们强烈建议保持这个系统以免整体失效。|r]=],
	["CO_RELATIONS"] = "关系",
	["CO_RELATIONS_DELETE_WARNING"] = "你是否要删除关系%s？",
	...
	["CO_RELATIONS_NEW_COLOR_TT"] = "这将会决定关系的颜色。",
	["CO_RELATIONS_NEW_ERROR"] = "你必须为新关系输入一个名字。",
	...
	["CO_TOOLBAR_VISIBILITY"] = "显示模式",
	["CO_TOOLBAR_VISIBILITY_1"] = "一直显示",
	["CO_TOOLBAR_VISIBILITY_2"] = "扮演时显示",
	["CO_TOOLBAR_VISIBILITY_3"] = "一直隐藏",
	["CO_TOOLBAR_VISIBILITY_HELP"] = "设置TRP3工具栏出现的条件。|n|n工具栏的可见模式可以通过使用|cnGREEN_FONT_COLOR:/trp3 switch toolbar|r指令强制调整或右击小地图调整。",
	["CO_TOOLTIP"] = "工具栏设置",
	["CO_TOOLTIP_ANCHOR"] = "固定点/锚点",
	["CO_TOOLTIP_ANCHORED"] = "固定框架",
	["CO_TOOLTIP_CHARACTER"] = "角色工具栏",
	["CO_TOOLTIP_CLIENT"] = "显示客户端",
	["CO_TOOLTIP_CLIENT_TT"] = "切换通知信息的客户端版本部分。",
	...
	["CO_TOOLTIP_GUILD_SHOW_WITH_ALL"] = "全部显示",
	["CO_TOOLTIP_GUILD_SHOW_WITH_CUSTOM"] = "显示自定义",
	["CO_TOOLTIP_GUILD_SHOW_WITH_ORIGINAL"] = "显示原始",
	["CO_TOOLTIP_GUILD_TT"] = "自定义公会身份在工具条上如何显示。",
	["CO_TOOLTIP_GUILD_TT_HIDDEN"] = "不在工具条显示公会身份。",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ALL"] = "分两行同时显示原版和自定义公会身份。",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_CUSTOM"] = "在工具条显示公会身份，如果人物卡有自定义名字或会阶就使用这个信息。",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ORIGINAL"] = "在工具条显示公会身份，但不使用人物卡中的自定义信息。",
	...
	["CO_TOOLTIP_HIDE_ON_MODIFIED_NEVER"] = "从不",
	["CO_TOOLTIP_HIDE_ON_MODIFIER"] = "隐藏键值",
	["CO_TOOLTIP_HIDE_ON_MODIFIER_TT"] = "当Ctrl或Alt键按下时隐藏自定义信息。",
	...
	["CO_TOOLTIP_RELATION_LINE"] = "显示关系",
	["CO_TOOLTIP_RELATION_LINE_FULL"] = "显示全部描述",
	["CO_TOOLTIP_RELATION_LINE_FULL_TT"] = "在工具栏显示玩家和目标名字的全部关系描述。",
	["CO_TOOLTIP_RELATION_LINE_HIDDEN_TT"] = "不在工具条显示任何关系信息。",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE"] = "只显示名字",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE_TT"] = "在工具条显示关系名字。",
	...
	["CO_TOOLTIP_SHOW_WORLD_CURSOR"] = "显示软目标单位的工具条",
	["CO_TOOLTIP_SHOW_WORLD_CURSOR_TT"] = "当你获取一个软目标时，显示自定义RP工具条。这个功能通常只在使用了ConsolePort这样的插件时有效。|n|n自定义工具条在工具条锚点被设置为“指针显示”时不会显示。",
	...
	["CO_TOOLTIP_VOICE_REFERENCE"] = "显示声音参考",
...
|cff00ff00U再次使用相同命令 (|cff999999/trp3 stash|cff00ff00) 恢复您的数据。|r]=],
	...
	["COPY_URL_POPUP_TEXT"] = "你可以使用键盘%s快捷键复制这个链接并在浏览器使用%s快捷键粘贴。",
	["CREDITS_DISCORD_LINK_TEXT"] = "加入我们的Discord",
	["CREDITS_GUILD_NAME"] = "<%1$s>",
	["CREDITS_NAME_WITH_ROLE"] = "%1$s (%2$s)",
	["CREDITS_THANK_YOU_ROLE_1"] = "项目主管",
	["CREDITS_THANK_YOU_ROLE_2"] = "作者",
	["CREDITS_THANK_YOU_ROLE_3"] = "开发者",
	["CREDITS_THANK_YOU_ROLE_4"] = "社区管理员",
	["CREDITS_THANK_YOU_ROLE_5"] = "吉祥物",
	["CREDITS_THANK_YOU_SECTION_1"] = "{h1:c}Total RP 3{/h1}",
	["CREDITS_VERSION_TEXT"] = "版本 %s",
	["CREDITS_WEBSITE_LINK_TEXT"] = "网站",
	["CURRENTLY_BUTTON_TT"] = "打开“当前”输入框来定义你的当前状态。",
	["CURRENTLY_COMMAND_HELP"] = "打开“当前”输入框。",
	["CURRENTLY_TITLE"] = "当前",
	...
	["DB_STATUS_CURRENTLY_OOC_TT"] = "对你来说比较重要的内容，作为角色或者OOC的。",
	["DB_STATUS_CURRENTLY_TT"] = "你的角色当前正在发生或和你的角色有关的内容。",
	...
	["DB_STATUS_RP"] = "角色状态",
	["DB_STATUS_RP_IC"] = "IC",
	["DB_STATUS_RP_IC_TT"] = "这个选项将让其他玩家知道你正在扮演状态，你的所有行为都是在扮演。",
	["DB_STATUS_RP_OOC"] = "OOC，不在RP",
	["DB_STATUS_RP_OOC_TT"] = "这个选项将让其他玩家知道你正在OOC状态，他们不应当将你的角色行为列入考虑。|n|n这将在姓名板上显示为一个红色通知。",
	["DB_STATUS_WU"] = "欢迎即兴RP",
	["DB_STATUS_WU_YES_TT"] = "告诉其他玩家你欢迎即兴RP。|n|n这将作为一个图标显示在你的姓名板上。",
	["DB_STATUS_XP"] = "角色扮演熟练度",
	["DB_STATUS_XP_NEWCOMER"] = "新手",
	["DB_STATUS_XP_NEWCOMER_GUIDE"] = "新手导师",
	["DB_STATUS_XP_NEWCOMER_GUIDE_TT"] = "这个选项将让新手角色扮演者知道你愿意帮助他们。|n|n这将作为一个图标显示在你的姓名板上。",
	["DB_STATUS_XP_NEWCOMER_TT"] = "这个选项将让其他玩家知道你是一个新手玩家。|n|n这将作为一个图标显示在你的姓名板上。",
	["DB_STATUS_XP_NORMAL"] = "休闲",
	["DB_STATUS_XP_NORMAL_TT"] = "这个选项会告诉其他玩家你是一个没有太多经验的休闲RP玩家。|n|n这不会在你的姓名板上显示任何图标。",
	["DB_STATUS_XP_VETERAN"] = "老手",
	["DB_STATUS_XP_VETERAN_TT"] = "这个选项将向其他玩家显示你是一个老手玩家。|n|n这不会在你的姓名板上显示任何图标。",
	["DB_TUTO_1"] = [=[|cffffff00角色状态|r 表示您当前是否在扮演角色.

|cffffff00角色状态|r 允许你说明你是一个初学者或者是一个愿意帮助新手的老手!

|cff00ff00这些信息将被放置在你的角色的工具栏中.|r]=],
	["DEFAULT_GUILD_RANK"] = "成员",
	...
	["LAUNCHER_ACTION_DIRECTORY"] = "打开目录页面",
	["LAUNCHER_ACTION_OPEN"] = "切换主窗口",
	["LAUNCHER_ACTION_PLAYER"] = "打开当前人物卡页面",
	["LAUNCHER_ACTION_PROFILES"] = "打开人物卡页面",
	["LAUNCHER_ACTION_SETTINGS"] = "打开设置页面",
	["LAUNCHER_ACTION_STATUS"] = "切换角色扮演状态",
	["LAUNCHER_ACTION_TOOLBAR"] = "切换工具条",
	["LAUNCHER_CONFIG_ACTIONS"] = "启动器动作",
	["LAUNCHER_CONFIG_ADDON_COMPARTMENT"] = "插件工具栏",
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON"] = "锁定小地图按钮",
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON_HELP"] = "如果勾选，防止小地图按钮被拖拽。",
	["LAUNCHER_CONFIG_MENU_TITLE"] = "小地图按钮",
	["LAUNCHER_CONFIG_PAGE_DESCRIPTION"] = "本页面的设置控制可以打开TRP3界面的各种按钮，比如小地图按钮。",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON"] = "重设小地图按钮位置",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON_HELP"] = "重设小地图按钮到默认位置。",
	["LAUNCHER_CONFIG_SHOW_ADDON_COMPARTMENT_BUTTON"] = "在插件工具栏中显示",
	...
	["MAP_SCAN_CHAR"] = "搜索角色",
	["MAP_SCAN_CHAR_GUILD_ONLY"] = "搜索公会成员",
	["MAP_SCAN_CHAR_GUILD_ONLY_TITLE"] = "公会",
...
{col:f2bf1a}{link*https://www.curseforge.com/wow/addons/total-rp-3-unit-frames*Download on CurseForge}{/col}]=],
	...
	["NAMEPLATES_CONFIG_CUSTOMIZE_GUILD"] = "显示自定义公会名",
	["NAMEPLATES_CONFIG_CUSTOMIZE_GUILD_HELP"] = "如果勾选，在姓名板上显示自定义公会名。",
	...
	["NAMEPLATES_CONFIG_CUSTOMIZE_NON_ROLEPLAY_UNITS"] = "自定义非角色扮演单位",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NON_ROLEPLAY_UNITS_HELP"] = "控制没有角色扮演人物卡的单位的自定义。",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NPC_UNITS"] = "自定义NPC单位",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NPC_UNITS_HELP"] = "控制NPC单位的自定义。",
	["NAMEPLATES_CONFIG_CUSTOMIZE_OOC_UNITS"] = "自定义OOC单位",
	["NAMEPLATES_CONFIG_CUSTOMIZE_OOC_UNITS_HELP"] = "控制OOC单位的自定义",
	...
	["NAMEPLATES_CONFIG_DISABLE_IN_INSTANCES"] = "关闭场景内自定义",
	["NAMEPLATES_CONFIG_DISABLE_IN_INSTANCES_HELP"] = "如果勾选，将禁用场景内的姓名板自定义内容。|n|n在场景中友善姓名板无法自定义。",
	...
	["NAMEPLATES_CONFIG_MAX_GUILD_NAME_CHARS"] = "最大公会名字长度",
	["NAMEPLATES_CONFIG_MAX_GUILD_NAME_CHARS_HELP"] = "公会名显示的最大字符长度。超过这个长度的公会名会被切断。",
	["NAMEPLATES_CONFIG_MAX_NAME_CHARS"] = "最大名字长度",
	["NAMEPLATES_CONFIG_MAX_NAME_CHARS_HELP"] = "姓名和角色前缀显示的最大字符长度。超过这个长度的名字会被切断。",
	["NAMEPLATES_CONFIG_MAX_TITLE_CHARS"] = "最大头衔长度",
	["NAMEPLATES_CONFIG_MAX_TITLE_CHARS_HELP"] = "头衔显示的最大字符长度。超过这个长度的头衔会被切断。",
	["NAMEPLATES_CONFIG_PAGE_HELP"] = "请注意目前只支持|cff449fe0暴雪|r，|cff9966ffKui|r，|cffa8deffPlater|r和|cffc69b6dPlatynator|r姓名版。请阅读设置选项下方的说明来了解如何设置。",
	["NAMEPLATES_CONFIG_PAGE_SETTINGS_MAY_REQUIRE_TOGGLE_HELP"] = "你可能需要开关你的姓名板来让设置生效。",
	["NAMEPLATES_CONFIG_PAGE_TEXT"] = "姓名版设置",
	["NAMEPLATES_CONFIG_SHOW_TARGET_UNIT"] = "总是显示目标单位",
	["NAMEPLATES_CONFIG_SHOW_TARGET_UNIT_HELP"] = "如果勾选，你的当前目标的姓名板将总是可见。",
	["NAMEPLATES_CONFIG_UNIT_NAME_FIRST"] = "显示名字",
	["NAMEPLATES_CONFIG_UNIT_NAME_FIRST_HELP"] = "只显示玩家的名字而不是全名。|n|n这对同伴和其他角色扮演插件的任务卡不起作用。",
	["NAMEPLATES_CONFIG_UNIT_NAME_FULL"] = "显示全名",
	["NAMEPLATES_CONFIG_UNIT_NAME_FULL_HELP"] = "显示单位的全名。",
	["NAMEPLATES_CONFIG_UNIT_NAME_ORIGINAL"] = "显示原名",
	["NAMEPLATES_CONFIG_UNIT_NAME_ORIGINAL_HELP"] = "显示单位不做修改的原本名字。",
	["NAMEPLATES_CONFIG_UNIT_STATE_DISABLE"] = "不做自定义",
	["NAMEPLATES_CONFIG_UNIT_STATE_DISABLE_HELP"] = "忽略这些单位的姓名板，不对其进行自定义。",
	["NAMEPLATES_CONFIG_UNIT_STATE_HIDE"] = "总是隐藏",
	["NAMEPLATES_CONFIG_UNIT_STATE_HIDE_HELP"] = "总是隐藏这些单位的姓名板。",
	["NAMEPLATES_CONFIG_UNIT_STATE_SHOW_HELP"] = "显示这些单位姓名板的所有自定义内容。|n|n这些姓名板的可见性可能被其他设置覆盖。",
...
您还可以在不使用NPC名字的情况下，将这个字段清空以创建表情。
	...
	["PLATER_NAMEPLATES_MODULE_DESCRIPTION"] = "启用Plater姓名板的自定义功能。",
	["PLATER_NAMEPLATES_MODULE_NAME"] = "Plater姓名板",
	["PLATER_NAMEPLATES_WARN_MOD_IMPORT_ERROR"] = "导入Plater mod时发生错误。",
	["PLATER_NAMEPLATES_WARN_OUTDATED_MODULE"] = "|cffa8deffPlater|r 姓名板已过期。",
	["PR_CO_BATTLE"] = "战斗宠物",
...
用导入的数据替换人物卡%s的所有内容?]=],
	...
	["REG_COMPANION_ICON"] = "同伴图标",
	["REG_COMPANION_ICON_TT"] = "选择一个代表你的同伴的图标。",
	...
	["REG_COMPANION_NAME_COLOR_TT"] = "你的同伴的名字颜色。",
...
你可以在描述中加入 |cffffff00图片，图标或者外部网页链接|r.]=],
	...
	["REG_COMPANION_TF_PROFILE_SPEECH"] = "同伴发言",
	["REG_COMPANION_TF_PROFILE_SPEECH_TT"] = "打开NPC发言框体并将你同伴的名字填进去。",
...
|cff00ff00%s|r]=],
	["REG_LIST_CHAR_TUTO_FILTER"] = "这些过滤器作用于以上的人物卡列表。|cnGREEN_FONT_COLOR:姓名过滤器|r将按你输入的姓名（IC或OOC的）过滤人物卡。|cnGREEN_FONT_COLOR:公会过滤器|r将按你输入的游戏性公会过滤人物卡。 |cnGREEN_FONT_COLOR:当前服务器过滤器|r将按你当前所在的服务器过滤人物卡。 |cnGREEN_FONT_COLOR:笔记过滤器|r将只显示你做过笔记的人物卡。",
	["REG_LIST_CHAR_TUTO_LIST"] = "|cnGREEN_FONT_COLOR:第一列|r的勾选框可以让你选择多个角色并用左上角的按钮进行操作。 |cnGREEN_FONT_COLOR第二列|r 显示角色的名字。|cnGREEN_FONT_COLOR:第三列n|r 显示这些角色和你的角色的关系。|cnGREEN_FONT_COLOR:第四列|r显示了你的TRP3上次保存这些人物卡的时间。|cnGREEN_FONT_COLOR:第五列n|r显示了这是什么插件产生的人物卡(Total RP 3， MyRoleplay，等等). |cnGREEN_FONT_COLOR:最后一列|r是一些标签（忽略等）。",
	["REG_LIST_FILTERS"] = "过滤",
	...
	["REG_LIST_IGNORE_REMOVE"] = "从忽略名单中移除",
...
骑士, 烟火生产者, 死灵法师, 游侠, 秘术师 ...]=],
	...
	["REG_PLAYER_CONVERT"] = "转换为|cnGREEN_FONT_COLOR:自定义|r",
	["REG_PLAYER_CONVERT_WARNING"] = "这条信息将 |cnWARNING_FONT_COLOR:不再显示在你的工具栏上|r。",
...
可以选择输入以下原因。这是一个个人笔记，可以作为提醒。]=],
	...
	["REG_PLAYER_MISC_ADD_TOOLTIP"] = "这条信息将|cnGREEN_FONT_COLOR:显示在你的工具栏上|r。",
	["REG_PLAYER_MISC_PRESET_GUILD_NAME"] = "公会名",
	["REG_PLAYER_MISC_PRESET_GUILD_RANK"] = "公会阶级",
	["REG_PLAYER_MISC_PRESET_PRONOUNS"] = "人称代词",
	["REG_PLAYER_MISC_PRESET_VOICE_REFERENCE"] = "声线参考",
	...
	["REG_PLAYER_NOTES_NOTICE"] = "创建一条笔记会在角色的姓名板上显示一个%s图标。",
...
比如他们可以 |c0000ff00苗条、肥胖和壮硕，也可以只是正常|r]=],
	...
	["REG_RELATION_BUSINESS_TT"] = "%1$s 和 %2$s 有着商业合作关系。",
	["REG_RELATION_BUTTON_TT"] = "|cnGREEN_FONT_COLOR:关系: %s|r|n%s",
	["REG_RELATION_BUTTON_TT_ACTIONS"] = "显示可能的操作",
	["REG_RELATION_FAMILY"] = "家人",
	["REG_RELATION_FAMILY_TT"] = "%1$s 和 %2$s 有着血缘关系。",
	["REG_RELATION_FRIEND"] = "朋友",
	["REG_RELATION_FRIEND_TT"] = "%1$s 认为 %2$s 是朋友。",
	["REG_RELATION_LOVE"] = "喜爱",
	["REG_RELATION_LOVE_TT"] = "%1$s 爱上了 %2$s !",
	["REG_RELATION_NEUTRAL"] = "中立的",
	["REG_RELATION_NEUTRAL_TT"] = "%1$s 对 %2$s 没有什么特别的感觉。",
	["REG_RELATION_NONE"] = "无",
	["REG_RELATION_NONE_TT"] = "%1$s 不认识 %2$s.",
	["REG_RELATION_TARGET"] = "改变关系",
	["REG_RELATION_UNFRIENDLY"] = "不友善",
	["REG_RELATION_UNFRIENDLY_TT"] = "%1$s 明显不喜欢 %2$s。",
	...
	["TB_SWITCH_CAPE_OFF"] = "披风: |cffff0000已隐藏|r",
	["TB_SWITCH_CAPE_ON"] = "披风: |cff00ff00已显示|r",
	["TB_SWITCH_HELM_1"] = "显示头盔",
	["TB_SWITCH_HELM_2"] = "隐藏头盔",
	["TB_SWITCH_HELM_OFF"] = "头盔: |cff00ff00已显示|r",
	["TB_SWITCH_HELM_ON"] = "头盔: |cff00ff00已显示|r",
	["TB_SWITCH_PROFILE"] = "切换到另一个人物卡",
	["TB_SWITCH_TOOLBAR"] = "切换工具条",
	["TB_TOOLBAR"] = "工具条",
	["TF_CHAR_THEME"] = "角色主题音乐",
	["TF_CHAR_THEME_PLAY"] = "播放音乐 %s",
	["TF_IGNORE"] = "忽略玩家",
...
TRP3.loc:RegisterNewLocale("zhCN", "简体中文", L);
