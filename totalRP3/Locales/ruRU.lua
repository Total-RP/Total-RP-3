...
|cnWARNING_FONT_COLOR:В WoW есть ошибка, из-за которой теряются все сохраненные профили, когда те достигают определенного порога. Мы настоятельно рекомендуем избегать отключения системы очистки.]=],
