...
L = {
	...
	["BW_COLOR_CODE_HEX"] = "Шестнадцатеричный код",
	["BW_COLOR_PRESET_DELETE"] = "Удалить цвет",
	["BW_COLOR_PRESET_RENAME"] = "Переименовать цвет",
	["BW_COLOR_PRESET_SAVE"] = "Сохранить текущий цвет",
	["BW_COLOR_PRESET_SELECT"] = "Выбрать цвет",
	["BW_COLOR_PRESET_TITLE"] = "Заготовленные цвета",
	["BW_COLOR_UNREADABLE"] = "Предупреждение Читаемости",
	["BW_COLOR_UNREADABLE_CLICK"] = "Использовать рекомендуемый цвет",
...
|cnWARNING_FONT_COLOR:В WoW есть ошибка, из-за которой теряются все сохраненные профили, когда те достигают определенного порога. Мы настоятельно рекомендуем избегать отключения системы очистки.|r]=],
	...
	["CO_TOOLBAR"] = "Панель инструментов",
	...
	["CO_TOOLTIP_TITLE_COLOR"] = "Цвет текста заголовка",
...
|cff00ff00Эта информация будет указана в описании вашего персонажа.|r]=],
	...
	["MAP_SCAN_CHAR_GUILD_ONLY"] = "Поиск членов гильдии",
...
Заменить всё содержимое профиля %s на импортируемые данные?]=],
	...
	["REG_COMPANION_NAME_COLOR_TT"] = "Цвет имени вашего спутника.",
...
|cffffff00Удалить из черного списка]=],
	...
	["REG_LIST_PET_OWNER"] = "Имя хозяина",
...
|rВы можете указать причину ниже. Другие игроки не смогут ее увидеть.]=],
	...
	["REG_PLAYER_REORDER"] = "Изменить порядок",
...
Если вы не хотите показывать характер вашего персонажа данным образом, оставьте флажок непомеченным и окно характера будет автоматически скрыто.]=],
	...
	["REG_PLAYER_STYLE_CRIME"] = "Принимать криминальную деятельность",
...
К примеру, она может быть |c0000ff00slim, толстый или мускулистый...|r Или она просто может быть обычной!]=],
	...
	["REG_RELATION_BUSINESS_TT"] = "%1$s и %2$s связаны деловыми отношениями.",
	...
	["REG_RELATION_FAMILY_TT"] = "%1$s связан кровными узами с %2$s.",
	["REG_RELATION_FRIEND"] = "Друг",
	["REG_RELATION_FRIEND_TT"] = "%1$s воспринимает %2$s как друга.",
	["REG_RELATION_LOVE"] = "Любовь",
	["REG_RELATION_LOVE_TT"] = "%1$s влюблен в %2$s !",
	["REG_RELATION_NEUTRAL"] = "Нейтральный",
	["REG_RELATION_NEUTRAL_TT"] = "%1$s абсолютно безразлично относится к %2$s.",
	["REG_RELATION_NONE"] = "Нет",
	["REG_RELATION_NONE_TT"] = "%1$s не знает %2$s",
	["REG_RELATION_TARGET"] = "Изменить отношение",
	["REG_RELATION_UNFRIENDLY"] = "Недружественный",
	["REG_RELATION_UNFRIENDLY_TT"] = "%1$s определенно не нравится %2$s",
	...
	["SLASH_CMD_SET_HELP_EXAMPLE1"] = "Мечтает о бабочках",
