...
The description doesn't have to be limited to |cnGREEN_FONT_COLOR:physical description|r. Feel free to indicate parts from their |cnGREEN_FONT_COLOR:background|r or details about their |cnGREEN_FONT_COLOR:personality|r.]],
	...
	CO_REGISTER_ABOUT_HIGH_CONTRAST = "High contrast about page",
	CO_REGISTER_ABOUT_HIGH_CONTRAST_TT = "Raises the contrast of the about page by removing any non-default backgrounds or text colors.\n\nDoes not prevent you from changing the background or text color in your own profile.",
