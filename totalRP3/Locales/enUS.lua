...
L = {
	...
	REG_PLAYER_COLOR_TT_OPTIONS = "Show color options",
	REG_PLAYER_COLOR_TT_COPY = "Copy color",
	REG_PLAYER_COLOR_TT_COPYNAME = "Copy color name",
	REG_PLAYER_COLOR_TT_PASTE = "Paste color",
	...
	REG_PLAYER_STYLE_LOSSOFCONTROL_TT = "Indicates whether this player is comfortable with |cnGREEN_FONT_COLOR:their character being subjected to loss of control|r, such as situations where their character is |cnGREEN_FONT_COLOR:temporarily imprisoned or mind controlled.|r",
...
These slots will also be visible on the target frame's |cnGREEN_FONT_COLOR:"At first glance"|r bar when someone selects your character.]],
	...
	REG_LIST_PET_OWNER = "Owner's name",
...
The description doesn't have to be limited to |cnGREEN_FONT_COLOR:physical description|r. Feel free to indicate parts from their |cnGREEN_FONT_COLOR:background|r or details about their |cnGREEN_FONT_COLOR:personality|r.]],
	...
	CO_REGISTER_ABOUT_HIGH_CONTRAST = "Make About pages easier to read",
	CO_REGISTER_ABOUT_HIGH_CONTRAST_TT = "Displays About pages with a |cnGREEN_FONT_COLOR:consistent background and text color|r, hiding custom backgrounds and text colors.\n\n|cnGREEN_FONT_COLOR:You can still customize|r the background and text colors of your own profile.",
	...
	CO_RELATIONS_CANNOT_EDIT = "This is the |cnGREEN_FONT_COLOR:default relation|r for all characters. It cannot be |cnWARNING_FONT_COLOR:edited, deleted, or moved|r.",
...
|cnGREEN_FONT_COLOR:Delete profile|r option allows you to remove the selected profile.]],
	...
	PR_IMPORT_ERROR_PEM_DECODE = "Failed to decode PEM block",
	...
	PR_SLASH_OPEN_REGIONAL_EXAMPLE = "Usage: |cnGREEN_FONT_COLOR:/trp3 open|r to open your target's profile, or |cnGREEN_FONT_COLOR:/trp3 open Character Name|r to open that character's profile.|r",
	PR_SLASH_OPEN_WAITING = "Requesting profile for |cnGREEN_FONT_COLOR:%s|r. Please wait...",
...
Total RP is not responsible for links leading to harmful content.|r]],
	...
	CM_RESIZE_RESET_TT = "Reset to default size",
...
Putting your companion name in [brackets] will allow color and icon customization.
	...
	AUTOMATION_CONDITION_TIME_ERROR = "Failed to check 'time' condition: invalid option '%s'.",
	AUTOMATION_CONDITION_WEATHER_ERROR = "Failed to check 'weather' condition: invalid option '%s'.",
	...
	AUTOMATION_TIME_AFTERNOON = "afternoon",
	AUTOMATION_TIME_DAY = "day",
	AUTOMATION_TIME_EVENING = "evening",
	AUTOMATION_TIME_MORNING = "morning",
	AUTOMATION_TIME_NIGHT = "night",
	AUTOMATION_WEATHER_CLEAR = "clear",
	AUTOMATION_WEATHER_RAIN = "rain",
	AUTOMATION_WEATHER_SANDSTORM = "sandstorm",
	AUTOMATION_WEATHER_SNOW = "snow",
...
If you wish to report %s's profile and you cannot target them you will need to open a ticket with Blizzard's support using the link bellow.]],
	...
	NAMEPLATES_CONFIG_MAX_TITLE_CHARS = "Maximum full title length",
	...
	NAMEPLATES_CONFIG_CUSTOMIZE_SUBTEXT = "Customize nameplate subtext",
	NAMEPLATES_CONFIG_CUSTOMIZE_SUBTEXT_HELP = "Select the type of subtext to display under the character's name.|n|nNote: For |cff449fe0Blizzard|r nameplates, subtext is only visible in name-only mode.",
	NAMEPLATES_CONFIG_SUBTEXT_FULL_TITLE = "Full Titles",
	NAMEPLATES_CONFIG_SUBTEXT_FULL_TITLE_HELP = "Displays the character's full-length title.",
	NAMEPLATES_CONFIG_SUBTEXT_GUILD_NAME = "Guild Name",
	NAMEPLATES_CONFIG_SUBTEXT_GUILD_NAME_HELP = "Displays guild names.|n|nEnabling |cnGREEN_FONT_COLOR:%s|r will override the default guild name.",
	NAMEPLATES_CONFIG_SUBTEXT_FULL_TITLE_GUILD_NAME = "Full Title + Guild Name",
	NAMEPLATES_CONFIG_SUBTEXT_FULL_TITLE_GUILD_NAME_HELP = "Displays the full title and guild name on separate lines.|n|nEnabling |cnGREEN_FONT_COLOR:%s|r will override the default guild name.",
	NAMEPLATES_CONFIG_SUBTEXT_NOTHING = "Nothing",
	NAMEPLATES_CONFIG_SUBTEXT_NOTHING_HELP = "Display nothing.",
	NAMEPLATES_CONFIG_TOOLTIP_FULL_TITLE_COLOR = "Full title color",
	NAMEPLATES_CONFIG_TOOLTIP_FULL_TITLE_COLOR_HELP = "Sets the color for the full-length title on nameplates.",
	NAMEPLATES_CONFIG_TOOLTIP_GUILD_NAME_COLOR = "Guild name color",
	NAMEPLATES_CONFIG_TOOLTIP_GUILD_NAME_COLOR_HELP = "Sets the color for the guild name on nameplates.",
	...
	ICON_CATEGORY_ACHIEVEMENTS = "Achievements",
	ICON_CATEGORY_ALCHEMY = "Alchemy",
	ICON_CATEGORY_ALL_ARMOR = "All Armor",
	ICON_CATEGORY_ALL_ITEMS = "All Items",
	ICON_CATEGORY_ALL_PROFESSIONS = "All Professions",
	ICON_CATEGORY_ALL_WEAPONS = "All Weapons",
	ICON_CATEGORY_ALLIANCE = "Alliance",
	ICON_CATEGORY_AMMO = "Ammo",
	ICON_CATEGORY_ARCANE = "Arcane",
	ICON_CATEGORY_ARCHAEOLOGY = "Archaeology",
	ICON_CATEGORY_ARMOR = "Armor",
	ICON_CATEGORY_AXE = "Axes",
	ICON_CATEGORY_BACK = "Back",
	ICON_CATEGORY_BLACKSMITHING = "Blacksmithing",
	ICON_CATEGORY_BOW = "Bows",
	ICON_CATEGORY_CHEST = "Chest",
	ICON_CATEGORY_CLASSES = "Classes",
	ICON_CATEGORY_CLOTH_ARMOR = "Cloth Armor",
	ICON_CATEGORY_COOKING = "Cooking",
	ICON_CATEGORY_CROSSBOW = "Crossbows",
	ICON_CATEGORY_CULTURE = "Cultures",
	ICON_CATEGORY_DAGGER = "Daggers",
	ICON_CATEGORY_DRACTHYR = "Dracthyr",
	ICON_CATEGORY_DRAENEI = "Draenei",
	ICON_CATEGORY_DRINK = "Drink",
	ICON_CATEGORY_DWARVEN = "Dwarven",
	ICON_CATEGORY_ELVEN = "Elven",
	ICON_CATEGORY_ENCHANTING = "Enchanting",
	ICON_CATEGORY_ENGINEERING = "Engineering",
	ICON_CATEGORY_FACTIONS = "Factions",
	ICON_CATEGORY_FEET = "Feet",
	ICON_CATEGORY_FEL = "Fel",
	ICON_CATEGORY_FIRE = "Fire",
	ICON_CATEGORY_FIRST_AID = "First Aid",
	ICON_CATEGORY_FISHING = "Fishing",
	ICON_CATEGORY_FIST_WEAPON = "Fist Weapons",
	ICON_CATEGORY_FOOD = "Food",
	ICON_CATEGORY_FROST = "Frost",
	ICON_CATEGORY_GNOMISH = "Gnomish",
	ICON_CATEGORY_GOBLIN = "Goblin",
	ICON_CATEGORY_GUN = "Guns",
	ICON_CATEGORY_HANDS = "Hands",
	ICON_CATEGORY_HARANIR = "Haranir",
	ICON_CATEGORY_HEAD = "Head",
	ICON_CATEGORY_HERBALISM = "Herbalism",
	ICON_CATEGORY_HOLY = "Holy",
	ICON_CATEGORY_HORDE = "Horde",
	ICON_CATEGORY_HOUSING = "Housing",
	ICON_CATEGORY_HUMAN = "Human",
	ICON_CATEGORY_INSCRIPTION = "Inscription",
	ICON_CATEGORY_INVENTORY_SLOTS = "Inventory Slots",
	ICON_CATEGORY_ITEMS = "Items",
	ICON_CATEGORY_JEWELCRAFTING = "Jewelcrafting",
	ICON_CATEGORY_JEWELRY = "Jewelry",
	ICON_CATEGORY_LEATHER_ARMOR = "Leather Armor",
	ICON_CATEGORY_LEATHERWORKING = "Leatherworking",
	ICON_CATEGORY_LEGS = "Legs",
	ICON_CATEGORY_MACE = "Maces",
	ICON_CATEGORY_MAGIC = "Magic",
	ICON_CATEGORY_MAIL_ARMOR = "Mail Armor",
	ICON_CATEGORY_MELEE_WEAPONS = "Melee Weapons",
	ICON_CATEGORY_MINING = "Mining",
	ICON_CATEGORY_MOUNT = "Mount",
	ICON_CATEGORY_NATURE = "Nature",
	ICON_CATEGORY_NECK = "Neck",
	ICON_CATEGORY_OFF_HAND = "Off Hand",
	ICON_CATEGORY_ORCISH = "Orcish",
	ICON_CATEGORY_OTHER_FACTIONS = "Other Factions",
	ICON_CATEGORY_PANDAREN = "Pandaren",
	ICON_CATEGORY_PET = "Pet",
	ICON_CATEGORY_PLATE_ARMOR = "Plate Armor",
	ICON_CATEGORY_POLEARM = "Polearms",
	ICON_CATEGORY_POTION = "Potion",
	ICON_CATEGORY_PROFESSIONS = "Professions",
	ICON_CATEGORY_RANGED_WEAPONS = "Ranged Weapons",
	ICON_CATEGORY_RING = "Rings",
	ICON_CATEGORY_SHADOW = "Shadow",
	ICON_CATEGORY_SHIELD = "Shield",
	ICON_CATEGORY_SHIRT = "Shirt",
	ICON_CATEGORY_SHOULDERS = "Shoulders",
	ICON_CATEGORY_SKINNING = "Skinning",
	ICON_CATEGORY_SPELLS_AND_ABILITIES = "Spells & Abilities",
	ICON_CATEGORY_STAFF = "Staves",
	ICON_CATEGORY_SWORD = "Swords",
	ICON_CATEGORY_TABARD = "Tabard",
	ICON_CATEGORY_TAILORING = "Tailoring",
	ICON_CATEGORY_TAUREN = "Tauren",
	ICON_CATEGORY_THROWN = "Thrown",
	ICON_CATEGORY_TRADE_GOODS = "Trade Goods",
	ICON_CATEGORY_TRINKET = "Trinkets",
	ICON_CATEGORY_TROLL = "Troll",
	ICON_CATEGORY_UNDEAD = "Undead",
	ICON_CATEGORY_VOID = "Void",
	ICON_CATEGORY_VULPERA = "Vulpera",
	ICON_CATEGORY_WAIST = "Waist",
	ICON_CATEGORY_WAND = "Wands",
	ICON_CATEGORY_WARGLAIVE = "Warglaives",
	ICON_CATEGORY_WEAPONS = "Weapons",
	ICON_CATEGORY_WORGEN = "Worgen",
	ICON_CATEGORY_WRISTS = "Wrists",
};
