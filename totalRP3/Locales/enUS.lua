...
L = {
	...
	REG_PLAYER_STYLE_INJURY_TT = "Indicates whether this character is comfortable with |cnGREEN_FONT_COLOR:your character getting injured|r.",
	REG_PLAYER_STYLE_DEATH = "Accept character death",
	REG_PLAYER_STYLE_DEATH_TT = "Indicates whether this character is comfortable with |cnGREEN_FONT_COLOR:your character dying|r.",
	REG_PLAYER_STYLE_ROMANCE = "Accept character romance",
	REG_PLAYER_STYLE_ROMANCE_TT = "Indicates whether this character is comfortable with |cnGREEN_FONT_COLOR:your character being romanced|r.",
	REG_PLAYER_STYLE_CRIME = "Accept criminal activity",
	REG_PLAYER_STYLE_CRIME_TT = "Indicates whether this character is comfortable with |cnGREEN_FONT_COLOR:your character being subjected to criminal activity|r, such as being mugged.",
	REG_PLAYER_STYLE_LOSSOFCONTROL = "Accept loss of control",
	REG_PLAYER_STYLE_LOSSOFCONTROL_TT = "Indicates whether this character is comfortable with |cnGREEN_FONT_COLOR:your character being subjected to loss of control|r, such as situations where your character is temporarily imprisoned or mind controlled.",
