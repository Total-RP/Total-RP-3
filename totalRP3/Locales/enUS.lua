...
It also works on the |cffffff00"At first glance" bar|r!]],
	...
	REG_RELATION_REPLACE_PLAYER = "player",
	REG_RELATION_REPLACE_TARGET = "target",
...
Class: 50 characters|r]],
	...
	CO_RELATIONS = "Relations settings",
	...
	CO_RELATIONS_NEW_ERROR_ID = "This relation already exists.",
	CO_RELATIONS_DELETE_WARNING = "Are you sure you want to delete the relation %s?",
	CO_RELATIONS_DELETE_ERROR = "You can't delete this relation.",
	CO_RELATIONS_NEW_DESCRIPTION = "Enter a description for the new relation. you can use the following tags: {%s} for your name, {%s} for your target's name",
	CO_RELATIONS_NEW_ERROR_DESCRIPTION = "You must enter a description for the new relation.",
	CO_RELATIONS_UPDATE_DESCRIPTION = "Enter a new description for the relation %s. you can use the following tags: {%s} for your name, {%s} for your target's name",
	CO_RELATIONS_UPDATE_DESCRIPTION_ERROR = "You must enter a description for the relation.",
	CO_RELATIONS_UPDATE_MENU_DESCRIPTION = "Update description",
	CO_RELATIONS_UPDATE_MENU_COLOR = "Update color",
	CO_RELATIONS_UPDATE_MENU_ICON = "Update icon",
	CO_RELATIONS_UPDATE_MENU_DELETE = "Delete relation",
