...
Putting your companion name in [brackets] will allow color and icon customization.
	...
	NEW_VERSION = "|cnGREEN_FONT_COLOR:A new version of Total RP 3 (%s) is available.|r|n|nWe strongly encourage you to stay up-to-date to |cnGREEN_FONT_COLOR:receive bug fixes and avoid incompatibilities|r.|n|nIssues from not updating the addon may include |cnRED_FONT_COLOR:not being be able to send or view character profiles correctly|r.",
