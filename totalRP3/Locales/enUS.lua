...
Putting your companion name in [brackets] will allow color and icon customization.
	...
	NEW_VERSION = "|cnGREEN_FONT_COLOR:A new version of Total RP 3 (%s) is available.|r|n|nWe strongly encourage you to stay up-to-date to |cnGREEN_FONT_COLOR:receive bug fixes and avoid potential incompatibilities|r.",
	NEW_VERSION_BEHIND = "You are currently multiple versions behind. |cnRED_FONT_COLOR:Other players may not be able to see your profile correctly|r until you have updated the addon.",
