...
Putting your companion name in [brackets] will allow color and icon customization.
	...
	AUTOMATION_PROFILE_COPY_HELP = "Copies all stored rules from this profile into the currently enabled one.|n|nThis will |cnRED_FONT_COLOR:irreversably replace|r all rules configured on the current profile.",
	...
	AUTOMATION_PROFILE_DELETE_HELP = "Deletes this profile.|n|nThis is an |cnRED_FONT_COLOR:irreversable|r process; deleted profiles cannot be restored.",
	...
	AUTOMATION_PROFILE_RESET_HELP = "Resets all stored rules on the currently enabled profile.|n|nThis will |cnRED_FONT_COLOR:irreversably delete|r all rules configured on the current profile.",
