...
The description doesn't have to be limited to |cnGREEN_FONT_COLOR:physical description|r. Feel free to indicate parts from their |cnGREEN_FONT_COLOR:background|r or details about their |cnGREEN_FONT_COLOR:personality|r.]],
	...
	CO_REGISTER_ABOUT_DISABLE_CUSTOM_BGS = "Use high contrast backgrounds",
	CO_REGISTER_ABOUT_DISABLE_CUSTOM_BGS_TT = "Uses only the high contrast background when viewing a profile's about page.\n\nDoes not prevent you from changing your own about page backgrounds.",
