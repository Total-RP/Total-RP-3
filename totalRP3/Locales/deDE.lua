...
|cff00ff00Diese Informationen werden im Tooltip deines Charakters angezeigt.|r]=],
	...
	["KUI_NAMEPLATES_WARN_OUTDATED_MODULE"] = "Das Kui |cff9966ffNameplates|r Plugin für Total RP 3 wurde in das Haupt Addon integriert.|n|nDas alte Plugin wurde automatisch deaktiviert, und |cffffcc00we empfiehlt es zu deinstallieren, da es nicht mehr benötigt wird.",
