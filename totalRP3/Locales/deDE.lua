...
L = {
	...
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_CHANGED_IC"] = "Rollenspielstatus wurde zu 'IC' geändert.",
	...
	["AUTOMATION_PROFILE_COPY_DIALOG_TITLE"] = "Bist du sicher, dass du alle Automatisierungsregeln von Profil |W|cnGREEN_FONT_COLOR:%s|r|w mit den Regeln von Profil |W|cnGREEN_FONT_COLOR:%s|r|w ersetzen möchtest?",
	["AUTOMATION_PROFILE_CREATE"] = "Profil erstellen",
	["AUTOMATION_PROFILE_CREATE_DIALOG_BUTTON1"] = "Erstellen",
	["AUTOMATION_PROFILE_CREATE_DIALOG_TITLE"] = "Gib einen Namen für das neue Automatisierungsprofil ein.",
	["AUTOMATION_PROFILE_DELETE"] = "Profil löschen",
	["AUTOMATION_PROFILE_DELETE_DIALOG_TITLE"] = "Bist du sicher, dass du das Profil |W|cnGREEN_FONT_COLOR:%s|r|w löschen möchtest?",
	["AUTOMATION_PROFILE_DELETE_HELP"] = "Löscht dieses Profil.|n|nDas ist ein |cnRED_FONT_COLOR:unumkehrbarer|r Prozess; gelöschte Profile können nicht wiederhergestellt werden.",
	["AUTOMATION_PROFILE_ENABLE"] = "Profil aktivieren",
	["AUTOMATION_PROFILE_ENABLE_HELP"] = "Aktiviert das Profil für den aktuellen Charakter.",
	["AUTOMATION_PROFILE_RESET"] = "Profil zurücksetzen",
	["AUTOMATION_PROFILE_RESET_DIALOG_TITLE"] = "Bist du sicher, dass du alle Automatisierungsregeln für das Profil |W|cnGREEN_FONT_COLOR:%s|r|w zurücksetzen möchtest?",
	["AUTOMATION_STATE_IC"] = "IC",
	["AUTOMATION_STATE_OOC"] = "OOC",
	["AUTOMATION_STATE_UNSET"] = "keine Änderung",
	["BINDING_NAME_TRP3_OPEN_TARGET_PROFILE"] = "Öffne Ziel Profil",
	["BINDING_NAME_TRP3_TOGGLE"] = "Hauptfenster umschalten",
	["BINDING_NAME_TRP3_TOGGLE_CHARACTER_STATUS"] = "Characterstatus umschalten",
...
Das Importieren des Inhaltes einer anderen Version könnte aufgrund von Inkompatibilitäten zu Problemen führen. Möchtest Du dennoch fortfahren?]=],
	...
	["CM_CMD"] = "Befehl",
	["CM_COLOR"] = "Farbe",
	["CM_COPY_TO_CLIPBOARD"] = "In die Zwischenablage kopieren",
	["CM_COPY_URL"] = "Link kopieren",
	["CM_CTRL"] = "Strg",
	["CM_CTRL_MAC"] = "Befehl",
	["CM_CYAN"] = "Türkis",
	["CM_DELETE"] = "Löschen",
	...
	["CM_OPT"] = "Option",
	["CM_OPTIONS"] = "Optionen",
	["CM_OPTIONS_ADDITIONAL"] = "Weitere Optionen",
	["CM_ORANGE"] = "Orange",
	["CM_PINK"] = "Pink",
	["CM_PLAY"] = "Abspielen",
	["CM_PURPLE"] = "Lila",
...
(Wenn diese Option eingeschaltet ist, kannst du mit Alt-Shift auf einen Namen klicken wenn du das ursprüngliche Verhalten verwenden möchtest und den Charakternamen statt den vollständigen RP-Namen einfügen möchtest.)]=],
	...
	["CO_CHAT_MAIN_EMOTE_USE"] = "Benutze Emote-Erkennung",
...
(ohne die " und mit einem Leerzeichen nach dem Strich)|r]=],
	...
	["CO_CURSOR_DISABLE_OOC_TT"] = "Deaktiviert Modifikationen vom Cursor während dein Rollenspielstatus |cnGREEN_FONT_COLOR:Out Of Character|r ist.",
	["CO_CURSOR_MODIFIER_KEY"] = "Modifiziertaste",
	["CO_CURSOR_MODIFIER_KEY_TT"] = "Erfordert, das eine Modifizierungs Taste gedrückt gehalten wird, um versehentliche Klicks zu vermeiden.",
...
|cnGREEN_FONT_COLOR:Note: Diese Funktion wird während eines Kampfes deaktiviert.|r]=],
	["CO_CURSOR_TITLE"] = "Cursorinteraktionen",
	["CO_CUSTOMIZATION"] = "Personalisierung",
	["CO_DATE_FORMAT"] = "Format des Datums",
	["CO_DATE_FORMAT_SPEC_a"] = "%1$s: Abgekürzter Name des Wochentags (%2$s)",
	["CO_DATE_FORMAT_SPEC_A"] = "%1$s: Vollständiger Name des Wochentags (%2$s)",
	["CO_DATE_FORMAT_SPEC_b"] = "%1$s: Abgekürzter Name des Monats (%2$s)",
	["CO_DATE_FORMAT_SPEC_B"] = "%1$s: Vollständiger Name des Monats (%2$s)",
	["CO_DATE_FORMAT_SPEC_d"] = "%1$s: Tag des Monats (%2$s)",
	["CO_DATE_FORMAT_SPEC_ESC"] = "%1$s: Das tatsächliche Zeichen '%%'",
	["CO_DATE_FORMAT_SPEC_H"] = "%1$s: Stunde unter Nutzung der 24-Stunden-Uhr (%2$s)",
	["CO_DATE_FORMAT_SPEC_I"] = "%1$s: Stunde unter Nutzung der 12-Stunden-Uhr (%2$s)",
	["CO_DATE_FORMAT_SPEC_m"] = "%1$s: Monat (%2$s)",
	["CO_DATE_FORMAT_SPEC_M"] = "%1$s: Minute (%2$s)",
	["CO_DATE_FORMAT_SPEC_p"] = "%1$s: Entweder 'AM' oder 'PM' (%2$s)",
	["CO_DATE_FORMAT_SPEC_S"] = "%1$s: Sekunde (%2$s)",
	["CO_DATE_FORMAT_SPEC_y"] = "%1$s: Zweistelliges Jahr (%2$s)",
	["CO_DATE_FORMAT_SPEC_Y"] = "%1$s: Volles Jahr (%2$s)",
	["CO_GENERAL"] = "Allgemein",
...
Wenn nicht, wird die Sprache beim nächsten Login geändert.]=],
	...
	["CO_GENERAL_CONTRAST_LEVEL"] = "Farbkontraststufe",
	["CO_GENERAL_CONTRAST_LEVEL_HELP"] = "Kontrolliert, wie stark benutzerdefinierte Farben für die Lesbarkeit auf dunklen Hintergründen angepasst werden.|n|nDie Einstellung 'Niedrig' ist die empfohlene Standardeinstellung und wirkt sich im Allgemeinen nur auf sehr dunkle Farben aus.",
	["CO_GENERAL_CONTRAST_LEVEL_HIGH"] = "Hoch",
	["CO_GENERAL_CONTRAST_LEVEL_LOW"] = "Niedrig",
	["CO_GENERAL_CONTRAST_LEVEL_MEDIUM_HIGH"] = "Mittel hoch",
	["CO_GENERAL_CONTRAST_LEVEL_MEDIUM_LOW"] = "Mittel niedrig",
	["CO_GENERAL_CONTRAST_LEVEL_MONOCHROMATIC"] = "Einfarbig",
	["CO_GENERAL_CONTRAST_LEVEL_NONE"] = "Keine",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_HIGH"] = "Sehr hoch",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_LOW"] = "Sehr niedrig",
	...
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE"] = "Willkommensnachricht deaktivieren",
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE_HELP"] = "Deaktiviert die Willkommensnachricht, die beim Login im Chatfenster angezeigt wird.",
	...
	["CO_GENERAL_HIDE_MAXIMIZE_BUTTON"] = "'Maximieren'-Schaltfläche ausblenden",
	...
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER"] = "Spieler mit OOC-Status anzeigen",
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER_TT"] = "Wenn ausgewählt, zeige auch Spieler die als OOC markiert sind auf der Karte an.",
...
|cnGREEN_FONT_COLOR:Wenn ein Modul deaktivert wird muss das UI neu geladen werden!|r]=],
	...
	["CO_REGISTER"] = "Verzeichnis",
	["CO_REGISTER_ABOUT_H1_SIZE"] = "Textgröße für Überschrift 1",
	["CO_REGISTER_ABOUT_H1_SIZE_TT"] = "Textgröße zwischen {h1}-Tags. Standard: %d",
	["CO_REGISTER_ABOUT_H2_SIZE"] = "Textgröße für Überschrift 2",
	["CO_REGISTER_ABOUT_H2_SIZE_TT"] = "Textgröße zwischen {h2}-Tags. Standard: %d",
	["CO_REGISTER_ABOUT_H3_SIZE"] = "Textgröße für Überschrift 3",
	["CO_REGISTER_ABOUT_H3_SIZE_TT"] = "Textgröße zwischen {h3}-Tags. Standard: %d",
	["CO_REGISTER_ABOUT_P_SIZE"] = "Textgröße für Paragrafen",
	["CO_REGISTER_ABOUT_P_SIZE_TT"] = "Textgröße außerhalb von Überschrift-Tags. Standard: %d",
	["CO_REGISTER_ABOUT_SETTINGS"] = "\"Über\"-Einstellungen",
...
|cnWARNING_FONT_COLOR:Es gibt einen Bug in WoW bei dem alle gespeicherten Daten verloren gehen, wenn ein bestimmtes Limit überschritten wird. Wir raten eindringlich davon ab das Bereinigungssystem abzuschalten.|r]=],
	["CO_RELATIONS"] = "Beziehungen",
	["CO_RELATIONS_DELETE_WARNING"] = "Bist du sicher, dass du Beziehung %s löschen möchtest?",
	...
	["CO_RELATIONS_NEW_COLOR_TT"] = "Hierdurch wird die Farbe der Beziehung bestimmt.",
	["CO_RELATIONS_NEW_ERROR"] = "Du musst der Beziehung einen Namen geben.",
	...
	["CO_TOOLBAR_VISIBILITY"] = "Anzeigebedingungen",
	["CO_TOOLBAR_VISIBILITY_1"] = "Immer anzeigen",
	["CO_TOOLBAR_VISIBILITY_2"] = "Nur anzeigen wenn IC",
	["CO_TOOLBAR_VISIBILITY_3"] = "Immer verborgen",
	["CO_TOOLBAR_VISIBILITY_HELP"] = "Konfiguriert die Konditionen, unter welchen die Toolbar angezeigt werden soll.|n|nDie Sichtbarkeit der Toolbar umzuschalten kann mit dem Befehl|cnGREEN_FONT_COLOR:/trp3 switch toolbar|r oder per Rechtsklick auf den Minimap Knopf erzwungen werden.",
	["CO_TOOLTIP"] = "Tooltip",
	...
	["CO_TOOLTIP_GUILD_SHOW_WITH_ALL"] = "Zeige alle",
	["CO_TOOLTIP_GUILD_SHOW_WITH_CUSTOM"] = "Zeige Individuell",
	["CO_TOOLTIP_GUILD_SHOW_WITH_ORIGINAL"] = "Zeige Original",
	["CO_TOOLTIP_GUILD_TT"] = "Passe an, wie die Gildenzugehörigkeit im Tooltip dargestellt wird.",
	["CO_TOOLTIP_GUILD_TT_HIDDEN"] = "Zeigt keine Gildenzugehörigkeit im Tooltip an.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ALL"] = "Zeigt sowohl die originale als auch die individuelle Gildenzugehörigkeit in separaten Zeilen im Tooltip an.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_CUSTOM"] = "Zeigt die Gildenzugehörigkeit im Tooltip und ersetzt den Namen und Rang, wenn diese im Charakterprofil angepasst wurden.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ORIGINAL"] = "Zeigt die Gildenzugehörigkeit im Tooltip, aber ersetzt nicht den Namen und Rang, wenn diese im Charakterprofil angepasst wurden.",
	["CO_TOOLTIP_HEALTH"] = "Gesundheit anzeigen",
	["CO_TOOLTIP_HEALTH_BOTH"] = "Nummer + Prozent",
	["CO_TOOLTIP_HEALTH_NUMBER"] = "Nummer",
	["CO_TOOLTIP_HEALTH_PERCENT"] = "Prozent",
	["CO_TOOLTIP_HEALTH_TT"] = "Wird nur angezeigt wenn das Ziel nicht bei voller Gesundheit ist.",
	["CO_TOOLTIP_HIDE_IN_INSTANCE"] = "Verbergen während einer Instanz",
	["CO_TOOLTIP_HIDE_ON_MODIFIED_NEVER"] = "Niemals",
	...
	["CO_TOOLTIP_MAIN_COLOR"] = "Haupttextfarbe",
	["CO_TOOLTIP_MAIN_COLOR_HELP"] = "Die Farbe, die im Tooltip verwendet wird, um Texte wie Volk, Stufe, 'Aktuelles' und OOC-Überschriften anzuzeigen.",
	...
	["CO_TOOLTIP_PRONOUNS"] = "Pronomen anzeigen",
	["CO_TOOLTIP_RACE"] = "Zeige Rasse, Klasse und Level",
	["CO_TOOLTIP_REALM"] = "Zeige Server",
	["CO_TOOLTIP_RELATION"] = "Zeige Beziehungsfarbe",
	["CO_TOOLTIP_RELATION_LINE"] = "Zeige Beziehung",
	["CO_TOOLTIP_RELATION_LINE_FULL"] = "Zeige vollständige Beschreibung",
	["CO_TOOLTIP_RELATION_LINE_FULL_TT"] = "Zeige die vollständige Beziehungsbeschreibung zusammen mit den Namen der Charaktere im Tooltip an.",
	["CO_TOOLTIP_RELATION_LINE_HIDDEN_TT"] = "Zeige keine Beziehungsinformation im Tooltip an.",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE"] = "Zeige nur Name",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE_TT"] = "Zeige den Beziehungsnamen im Tooltip an.",
	["CO_TOOLTIP_RELATION_TT"] = "Fügt dem Rand des Charaktertooltips eine Farbe hinzu, um die Beziehung zu repräsentieren.",
	["CO_TOOLTIP_SECONDARY_COLOR"] = "Sekundäre Textfarbe",
	...
	["CO_TOOLTIP_TITLE_COLOR"] = "Titel Textfarbe",
	["CO_TOOLTIP_USE"] = "Benutze die Tooltips für Charaktere/Begleiter",
	["CO_TOOLTIP_VOICE_REFERENCE"] = "Zeige Stimmreferenz",
	["CO_TOOLTIP_ZONE"] = "Gebiet anzeigen",
	["CO_TOOLTIP_ZONE_TT"] = "Wird nur angezeigt, wenn das Ziel sich nicht im selben Gebiet befindet wie du.",
...
|cff00ff00Nutze den selben Befehl nochmal (|cff999999/trp3 stash|cff00ff00) um die Daten wiederherzustellen.|r]=],
	...
	["COPY_DROPDOWN_POPUP_TEXT"] = "Kopieren mit %1$s. Einfügen mit %2$s. Dieses Fenster wird beim Kopieren automatisch geschlossen.",
	["COPY_SYSTEM_MESSAGE"] = "In die Zwischenablage kopiert.",
	["COPY_URL_POPUP_TEXT"] = "Du kannst diesen URL mit %s kopieren und mit %s im Browser deiner Wahl einfügen.",
	["CREDITS_DISCORD_LINK_TEXT"] = "Tritt unserem Discord bei",
	["CREDITS_GUILD_NAME"] = "<%1$s>",
	["CREDITS_NAME_WITH_ROLE"] = "%1$s (%2$s)",
	["CREDITS_THANK_YOU_ROLE_1"] = "Projektleitung",
	["CREDITS_THANK_YOU_ROLE_2"] = "Autor",
	["CREDITS_THANK_YOU_ROLE_3"] = "Entwickler",
	["CREDITS_THANK_YOU_ROLE_4"] = "Community-Manager",
	["CREDITS_THANK_YOU_ROLE_5"] = "Maskottchen",
	["CREDITS_THANK_YOU_SECTION_1"] = "{h1:c}Total RP 3{/h1}",
	["CREDITS_THANK_YOU_SECTION_10"] = "{col:ffffff}Vielen Dank an unsere aktiven Community-Mitglieder auf Discord:{/col}",
	["CREDITS_THANK_YOU_SECTION_11"] = "{col:ffffff}Vielen Dank an Bor Blasthammer für seine Hilfe bei den Bfa-Tests.{/col}",
	...
	["CREDITS_THANK_YOU_SECTION_9"] = "{col:ffffff}Vielen Dank an Horionne für die Zusendung der Zeitschrift 'Gamer Culte Online #14' mit einem Artikel über Total RP.{/col}",
	["CREDITS_VERSION_TEXT"] = "Version %s",
	["CREDITS_WEBSITE_LINK_TEXT"] = "Webseite",
	["CURRENTLY_BUTTON_TT"] = "Öffne das 'Aktuelles'-Fenster um deinen 'Aktuelles'-Status zu bearbeiten.",
	["CURRENTLY_COMMAND_HELP"] = "Öffne das 'Aktuelles'-Fenster.",
	["CURRENTLY_TITLE"] = "Aktuelles",
	...
	["DB_STATUS_CURRENTLY_OOC_TT"] = "Alles was über dich als Spieler oder OOC wichtig ist.",
	["DB_STATUS_CURRENTLY_TT"] = "Alles, was aktuell passiert oder gerade relevant für deinen Charakter ist.",
	...
	["DB_STATUS_RP_IC_TT"] = "Diese Auswahl zeigt anderen Spielern an, dass du gerade in Charakter bist und dass alle Aktionen deines Charakters als solche betrachtet werden sollten.|n|nDies wird als grüner Hinweis in deinem Tooltip angezeigt.",
	["DB_STATUS_RP_OOC"] = "Out of Character (OOC)",
	["DB_STATUS_RP_OOC_TT"] = "Diese Auswahl zeigt anderen Spielern an, dass du gerade nicht in Charakter bist und dass sie die Aktionen deines Charakters nicht berücksichtigen sollten.|n|nDies wird als roter Hinweis in deinem Tooltip angezeigt.",
	["DB_STATUS_WU"] = "Anspielbereit",
	["DB_STATUS_WU_YES_TT"] = "Lass andere Spieler wissen, das es in Ordnung für dich ist angespielt zu werden, wenn du IC herumstehst.|n|nDies wird als Symbol in deinem Tooltip angezeigt.",
	["DB_STATUS_XP"] = "Rollenspielerfahrung",
	["DB_STATUS_XP_NEWCOMER"] = "Frischling",
	["DB_STATUS_XP_NEWCOMER_GUIDE"] = "Rollenspielmentor",
	["DB_STATUS_XP_NEWCOMER_GUIDE_TT"] = "Diese Auswahl zeigt Anfängern im Rollenspiel, dass du bereit bist, ihnen zu helfen.|n|nDies wird als Symbol in deinem Tooltip angezeigt.",
	["DB_STATUS_XP_NEWCOMER_TT"] = "Diese Auswahl zeigt anderen Spielern, dass du noch ein Anfänger im Rollenspiel bist.|n|nDies wird als Symbol in deinem Tooltip angezeigt.",
	["DB_STATUS_XP_NORMAL"] = "Teilzeit",
	["DB_STATUS_XP_NORMAL_TT"] = "Diese Auswahl zeigt anderen Spielern, dass du ein Gelegenheitsrollenspieler ohne spezifische Erfahrungsebene bist.|n|nDies wird kein spezielles Symbol in deinem Tooltip anzeigen.",
	["DB_STATUS_XP_VETERAN"] = "Veteran",
	["DB_STATUS_XP_VETERAN_TT"] = "Diese Auswahl zeigt anderen Spielern, dass es sich bei dir um einen erfahrenen Rollenspieler handelt.|n|nDies wird kein spezielles Symbol in deinem Tooltip anzeigen.",
...
|cff00ff00Diese Informationen werden im Tooltip deines Charakters angezeigt.|r]=],
	...
	["KUI_NAMEPLATES_MODULE_DESCRIPTION"] = "Ermöglicht die Veränderung von Kui Nameplates",
	["KUI_NAMEPLATES_MODULE_NAME"] = "Kui Nameplates",
	["KUI_NAMEPLATES_WARN_OUTDATED_MODULE"] = "Das Kui |cff9966ffNameplates|r Plugin für Total RP 3 wurde in das Haupt Addon integriert.|n|nDas alte Plugin wurde automatisch deaktiviert, und |cffffcc00we empfiehlt es zu deinstallieren|r, da es nicht mehr benötigt wird.",
	...
	["MAP_SCAN_CHAR_GUILD_ONLY"] = "Nach Gildenmitgliedern scannen",
	["MAP_SCAN_CHAR_GUILD_ONLY_TITLE"] = "Gilde",
...
Trotzdem verbinden?]=],
	...
	["PR_DEFAULT_PROFILE_NAME"] = "Standardprofil",
...
Die änderung des Namens verändert nicht die Verbindung zwischen dem Profil und den Charakteren.]=],
	["PR_PROFILEMANAGER_EMPTY"] = "Keine Profile gefunden",
...
Den gesamten Inhalt des Profils %s mit den importierten Daten überschreiben?]=],
	...
	["PR_PROFILEMANAGER_SEARCH_PROFILE"] = "Profil suchen",
...
Wechsel zu einem anderen Profil mit diesem Namen.]=],
	...
	["REG_COMPANION_BIND_TO_PET"] = "Haustier",
	...
	["REG_COMPANION_ICON"] = "Begleitericon",
	["REG_COMPANION_ICON_TT"] = "Wähle einen Icon der deinen Begleiter respräsentiert.",
...
|cff00ff00%s|r]=],
	...
	["REG_LIST_CHAR_NAME_COPY"] = "Charaktername kopieren",
	["REG_LIST_CHAR_SEL"] = "Charakter wählen",
	["REG_LIST_CHAR_TITLE"] = "Charaktere",
...
|cff00ff00%s|r]=],
	...
	["REG_LIST_IGNORE_REMOVE"] = "Von Ignorierliste entfernen",
	["REG_LIST_IGNORE_TITLE"] = "Ignoriert",
	["REG_LIST_IGNORE_TT"] = [=[Grund:
|cff00ff00%s

|cffffff00Klicken, um von der Liste zu streichen]=],
	["REG_LIST_NAME"] = "Name das Charakters",
	["REG_LIST_NOTESONLY"] = "Nur mit Notiz",
	...
	["REG_LIST_PETS_TITLE"] = "Begleiters",
...
- Oder ein Adjektiv (jung, ausgewachsen, erwachsen, steinalt, etc.).]=],
	["REG_PLAYER_ALERT_HEAVY_SMALL"] = [=[|cnWARNING_FONT_COLOR:Dein Profil ist sehr lang.|r
Du solltest versuchen, die Länge reduzieren.]=],
...
Ritter, Pyromane, Nekromant, Eliteschütze, Arkanwirker, Magd ...]=],
	...
	["REG_PLAYER_COLOR_TT_DISCARD"] = "Farbe abwählen",
	["REG_PLAYER_COLOR_TT_SELECT"] = "Wähle eine Farbe",
	["REG_PLAYER_CONVERT_WARNING"] = "Diese Information wird |cnWARNING_FONT_COLOR:nicht mehr in deinem Tooltip angezeigt|r.",
...
|cff00ff00Hinweis: Wenn der Name bereits von einer anderen Voreinstellung genutzt wird, wird diese ersetzt.]=],
	...
	["REG_PLAYER_GLANCE_CONFIG_EDIT"] = "Slot konfigurieren",
	["REG_PLAYER_GLANCE_CONFIG_REORDER"] = "Slots neu anordnen",
	["REG_PLAYER_GLANCE_CONFIG_TOGGLE"] = "Slot aktivierung umschalten",
...
|cff00ff00%s|r.]=],
	["REG_PLAYER_HERE_HOME_TT_CURRENT"] = "Verwende deine aktuellen Koordinaten als Heimatort-Position",
	["REG_PLAYER_HERE_HOME_TT_DISCARD"] = "Entferne deine Heimatort-Position",
	["REG_PLAYER_HERE_TT"] = "Auf die aktuelle Position setzen",
...
|rOptional kannst du einen Grund angeben. Dies ist eine persönliche Notiz und kann nur von dir eingesehen werden.]=],
	...
	["REG_PLAYER_MISC_ADD_TOOLTIP"] = "Diese Information wird |cnGREEN_FONT_COLOR:in deinem Tooltip angezeigt|r.",
	["REG_PLAYER_MISC_PRESET_GUILD_NAME"] = "Gildenname",
	["REG_PLAYER_MISC_PRESET_GUILD_RANK"] = "Gildenrang",
	["REG_PLAYER_MISC_PRESET_PRONOUNS"] = "Pronomen",
	["REG_PLAYER_MISC_PRESET_VOICE_REFERENCE"] = "Stimmreferenz",
	...
	["REG_PLAYER_PSYCHO_CUSTOMCOLOR_LEFT_TT"] = "Wähle eine Farbe, die das linke Merkmal benutzt.",
	["REG_PLAYER_PSYCHO_CUSTOMCOLOR_RIGHT_TT"] = "Wähle eine Farbe, die das rechte Merkmal benutzt.",
	["REG_PLAYER_PSYCHO_DECEITFUL"] = "Unehrlich",
	["REG_PLAYER_PSYCHO_FORGIVING"] = "Vergebend",
	["REG_PLAYER_PSYCHO_GENTLE"] = "Sanft",
	["REG_PLAYER_PSYCHO_IMPULSIVE"] = "Impulsiv",
	["REG_PLAYER_PSYCHO_LAWFUL"] = "Rechtschaffen",
	["REG_PLAYER_PSYCHO_LEFTICON_TT"] = "Linkes Attributsicon auswählen.",
	["REG_PLAYER_PSYCHO_LUSTFUL"] = "Lüstern",
	["REG_PLAYER_PSYCHO_PARAGON"] = "Vorbildlich",
	["REG_PLAYER_PSYCHO_PERSONAL"] = "Persönliche Werte",
	["REG_PLAYER_PSYCHO_RATIONAL"] = "Rational",
	["REG_PLAYER_PSYCHO_RENEGADE"] = "Abtrünnig",
	["REG_PLAYER_PSYCHO_RIGHTICON_TT"] = "Rechtes Attributsicon auswählen.",
	["REG_PLAYER_PSYCHO_SELFISH"] = "Egoistisch",
	["REG_PLAYER_PSYCHO_SOCIAL"] = "Soziale Werte",
	["REG_PLAYER_PSYCHO_SPINELESS"] = "Rückgratlos",
	["REG_PLAYER_PSYCHO_SUPERSTITIOUS"] = "Abergläubisch",
	["REG_PLAYER_PSYCHO_TRUTHFUL"] = "Ehrlich",
	["REG_PLAYER_PSYCHO_VALOROUS"] = "Tapfer",
	["REG_PLAYER_PSYCHO_VINDICTIVE"] = "Rachsüchtig",
	...
	["REG_PLAYER_REORDER"] = "Neu anordnen",
	["REG_PLAYER_REORDER_TT"] = "Dieses Feld neu anordnen.",
	["REG_PLAYER_RESIDENCE"] = "Heimat",
	["REG_PLAYER_RESIDENCE_SHOW"] = "Wohnort Koordinaten",
	["REG_PLAYER_RESIDENCE_SHOW_TT"] = "Auf Karte anzeigen",
...
Wenn du die Persönlichkeit deines Charakter auf diese Art nicht angeben möchtest, dann wähle die Option nicht aus und das Persönlichkeitsfenster wird nicht angezeigt werden.]=],
	...
	["REG_PLAYER_STYLE_CRIME"] = "Akzeptiere kriminelle Aktivitäten",
	["REG_PLAYER_STYLE_CRIME_TT"] = "Zeigt an, ob der Spieler damit einverstanden ist, dass |cnGREEN_FONT_COLOR:sein Charakter kriminellen Aktivitäten ausgesetzt wird|r, wie z.B. überfallen zu werden.",
	["REG_PLAYER_STYLE_DEATH"] = "Akzeptiere Charaktertod",
	["REG_PLAYER_STYLE_DEATH_TT"] = "Zeigt an, ob der Spieler damit einverstanden ist, dass |cnGREEN_FONT_COLOR:sein Charakter stirbt|r.",
	...
	["REG_PLAYER_STYLE_GUILD_TT"] = "Zeigt den |cnGREEN_FONT_COLOR:Rollenspielstatus der Mitgliedschaft dieses Spielers in seiner Gilde an.|r",
	["REG_PLAYER_STYLE_INJURY"] = "Akzeptiere Charakterverletzungen",
	["REG_PLAYER_STYLE_INJURY_TT"] = "Zeigt an, ob der Spieler damit einverstanden ist, dass |cnGREEN_FONT_COLOR:sein Charakter verletzt wird|r.",
	["REG_PLAYER_STYLE_LOSSOFCONTROL"] = "Akzeptiere Kontrollverlust",
	["REG_PLAYER_STYLE_LOSSOFCONTROL_TT"] = "Zeigt an, ob der Spieler damit einverstanden ist, dass |cnGREEN_FONT_COLOR:sein Charakter einem Kontrollverlust ausgesetzt wird|r, wie z.B. in Situationen in denen der Charakter |cnGREEN_FONT_COLOR:vorübergehend gefangen gehalten wird oder unter Gedankenkontrolle steht.|r",
	["REG_PLAYER_STYLE_PERMI"] = "Mit Spielererlaubnis",
	["REG_PLAYER_STYLE_ROMANCE"] = "Akzeptiere Charakterromanze",
	["REG_PLAYER_STYLE_ROMANCE_TT"] = "Zeigt an, ob der Spieler damit einverstanden ist, dass |cnGREEN_FONT_COLOR:sein Charakter eine Romanze eingeht|r.",
...
Jedes Fenster wird von einem eigenen |cffffff00Icon, einem Hintergrund und einem Text|r repräsentiert. Beachte das du hier Texttags in diesen Fenstern nutzen kannst, genauso kannst du auch Farb- oder Icon-Tags verwenden.]=],
	["REG_PLAYER_TUTO_FORMATTING_TOOLS"] = "Mit den Formatierungstools haben Sie Zugriff auf verschiedene |cnGREEN_FONT_COLOR:Layoutparameter|r (Textgröße, Farbe und Ausrichtung). Sie können auch |cnGREEN_FONT_COLOR:Bilder, Symbole oder Links zu externen Websites einfügen|r.",
	["REG_PLAYER_WALKUP_TT"] = "Dieser Spieler hat kein Problem damit, wenn man ihn einfach anspielt.",
...
Zum Beispiel kann du folgendes angeben: |c0000ff00schlank, dick or muskulös...|r oder einfach durchschnittlich!]=],
	...
	["REG_RELATION_BUSINESS_TT"] = "%1$s und %2$s haben eine Geschäftsbeziehung.",
	["REG_RELATION_BUTTON_TT"] = "|cnGREEN_FONT_COLOR:Beziehung: %s|r|n%s",
	["REG_RELATION_BUTTON_TT_ACTIONS"] = "Mögliche Aktionen anzeigen",
	["REG_RELATION_FAMILY"] = "Familie",
	["REG_RELATION_FAMILY_TT"] = "%1$s hat Blutsbande mit %2$s.",
	["REG_RELATION_FRIEND"] = "Freundlich",
	["REG_RELATION_FRIEND_TT"] = "%1$s nennt %2$s einen Freund.",
	["REG_RELATION_LOVE"] = "Liebe",
	["REG_RELATION_LOVE_TT"] = "%1$s ist in %2$s verliebt!",
	["REG_RELATION_NEUTRAL"] = "Neutral",
	["REG_RELATION_NEUTRAL_TT"] = "%1$s hat keine spezielle Beziehung zu %2$s.",
	["REG_RELATION_NONE"] = "Keine",
	["REG_RELATION_NONE_TT"] = "%1$s kennt %2$s nicht.",
	["REG_RELATION_TARGET"] = "Beziehung ändern",
	["REG_RELATION_UNFRIENDLY"] = "Unfreundlich",
	["REG_RELATION_UNFRIENDLY_TT"] = "%1$s mag %2$s offensichtlich nicht.",
	...
	["REG_TT_GUILD"] = "%s der %s",
	["REG_TT_GUILD_CUSTOM"] = "Inoffizielle Gilde",
	...
	["REG_TT_NOTIF_LONG_TT"] = "Der Inhalt dieser Profilbeschreibung hat sich seit deinem letzten Besuch geändert.",
	["REG_TT_NOTIF_TT"] = "Der Inhalt dieses Bereichs hat sich seit deinem letzten Besuch geändert.",
	...
	["SLASH_CMD_HELP_COMMANDS"] = "Befehle: %1$s",
	["SLASH_CMD_HELP_EXAMPLES"] = "Beispiele: %1$s",
	["SLASH_CMD_HELP_FIELDS"] = "Felder: %1$s",
	["SLASH_CMD_SET_HELP_ARG1"] = "<Feld>",
	["SLASH_CMD_SET_HELP_EXAMPLE1"] = "Tagträumen über Schmetterlinge",
	["SLASH_CMD_SET_HELP_EXAMPLE2"] = "Glücklicher Bär; Wütende Elfe",
	...
	["TB_RPSTATUS_TO_OFF"] = "Zu Out of Character wechseln.",
	["TB_RPSTATUS_TO_ON"] = "Zu In Character wechseln.",
	["TB_STATUS"] = "Spieler",
	["TB_SWITCH_CAPE_1"] = "Zeige Umhang",
	["TB_SWITCH_CAPE_2"] = "Verstecke Umhang",
	["TB_SWITCH_CAPE_OFF"] = "Umhang: |cffff0000Versteckt|r",
	["TB_SWITCH_CAPE_ON"] = "Umhang: |cff00ff00Angezeigt|r",
	["TB_SWITCH_HELM_1"] = "Zeige Helm",
	["TB_SWITCH_HELM_2"] = "Verstecke Helm",
	["TB_SWITCH_HELM_OFF"] = "Helm: |cffff0000Versteckt|r",
	["TB_SWITCH_HELM_ON"] = "Helm: |cff00ff00Angezeigt|r",
...
|cffff7700Du kannst optional angeben, warum die diesen Spieler ignorierst. Dies ist eine persönliche Notiz und kann nicht von anderen Spielern eingesehen werden.|r]=],
	...
	["TF_IGNORE_TT"] = "Verstecke das Profil dieses Charakters. Dein Profil oder Kartenstandort wird nicht mehr mit ihm geteilt.",
	["TF_MORE_OPTIONS"] = "Weitere Optionen",
...
{col:ffffff}Danke an Horionne für das zusend einer Ausgabe von dem Magazin "Gamer Culte Online #14" mit einem Artikel über Total RP.{/col}]=],
	...
	["UI_BKG_BROWSER"] = "Hintergrund-Browser",
	["UI_BKG_BUTTON"] = "Hintergrund ändern",
	...
	["UI_COMPANION_BROWSER_RENAME_WARNING"] = "|cffff0000Warnung:|r Es wird dringend empfohlen, nur Begleiterprofile mit umbenannten Haustieren zu verknüpfen.",
	["UI_FILTER"] = "Filter",
	["UI_FILTER_NO_RESULTS_FOUND_TEXT"] = "Versuche, deine Suchkriterien anzupassen.",
	["UI_FILTER_NO_RESULTS_FOUND_TITLE"] = "Keine Ergebnisse gefunden.",
	["UI_ICON_BROWSER"] = "Iconbrowser",
	["UI_ICON_BROWSER_SEARCHING"] = "Suche...",
	["UI_ICON_COPY"] = "Icon kopieren",
	["UI_ICON_COPYNAME"] = "Iconname kopieren",
	["UI_ICON_OPENBROWSER"] = "Icon-Browser öffnen",
	["UI_ICON_OPTIONS"] = "Zeige Icon-Optionen",
	["UI_ICON_PASTE"] = "Icon kopieren",
...
Total RP ist NICHT für Links verantwortlich, die auf schädlichen oder illegalen Inhalt verweisen!]=],
	...
	["UI_PET_BROWSER_ACCEPT"] = "Zuweisen",
	["UI_PET_BROWSER_BOUND_WARNING"] = "|cffff0000Warnung:|r Dieses Haustier ist derzeit mit dem Profil |cff00ff00%1$s|r verlinkt. Wenn du ein anderes Profil mit diesem Haustier verknüpfst, wird das aktuelle Profil ersetzt.",
	["UI_PET_BROWSER_EMPTY_TEXT"] = "Du hast keine Haustiere die mit einem Profil verlinkt werden können.",
	["UI_TUTO_BUTTON"] = "Tutorialmodus",
	["UI_TUTO_BUTTON_TT"] = "Tutorialmodus ein/aus zu schalten",
	["UNIT_POPUPS_CHARACTER_STATUS"] = "Charakterstatus",
	["UNIT_POPUPS_CONFIG_DISABLE_IN_COMBAT"] = "Verberge Menüeinträge wenn im Kampf",
	["UNIT_POPUPS_CONFIG_DISABLE_IN_COMBAT_HELP"] = "Wenn diese Option aktiviert ist, werden während eines Kampfes keine zusätzlichen Menüeinträge angezeigt.",
	["UNIT_POPUPS_CONFIG_DISABLE_IN_INSTANCES"] = "Verberge Menüeinträge wenn in Instanzen",
	["UNIT_POPUPS_CONFIG_DISABLE_IN_INSTANCES_HELP"] = "Wenn diese Option aktiviert ist, werden in instanzierten Gebieten keine zusätzlichen Menüeinträge angezeigt.",
	["UNIT_POPUPS_CONFIG_ENABLE_MODULE"] = "Modul |cff00ff00aktiviert|r",
	["UNIT_POPUPS_CONFIG_ENTRIES_HEADER"] = "Menüeinträge",
	["UNIT_POPUPS_CONFIG_MENU_TITLE"] = "Einheitenmenüs",
	["UNIT_POPUPS_CONFIG_PAGE_TEXT"] = "Einheitenmenüs",
	["UNIT_POPUPS_CONFIG_SHOW_SEPARATOR"] = "Zeige Trennlinie",
	["UNIT_POPUPS_CONFIG_VISIBILITY_HEADER"] = "Optionen zur Sichtbarkeit",
	["UNIT_POPUPS_CURRENT_PROFILE"] = "Aktuelles Profil",
	["UNIT_POPUPS_CURRENT_PROFILE_NAME"] = "Aktuelles Profil: %1$s",
	["UNIT_POPUPS_MODULE_DESCRIPTION"] = "Fügt integration mit Kontextmenüs an Einheiten Fenstern und Spielernamen in Chat Fenstern hinzu.",
	["UNIT_POPUPS_OPEN_PROFILE"] = "Profil öffnen",
	["UNIT_POPUPS_ROLEPLAY_OPTIONS_HEADER"] = "Rollenspiel Optionen",
	["URL_COPY_INSTRUCTIONS"] = "Drücke |cnGREEN_FONT_COLOR:%1$s|r um den hervorgehobenen Link zu kopieren, und füge ihn dann in einen Webbrowser ein mit |cnGREEN_FONT_COLOR:%2$s|r.",
	["URL_COPY_TITLE"] = "Link kopieren",
	["URL_COPY_WARNING"] = "|cnWARNING_FONT_COLOR:Total RP ist nicht verantwortlich für externe verlinkte Inhalte.|r"
};
