...
（除了 " 符號，並在管狀符號後方加上空格。）|r]=],
	...
	["CO_CURSOR_RIGHT_CLICK_TT"] = [=[右鍵點擊玩家人物模組即可開啟角色資訊欄。
|TInterface\Cursor\WorkOrders:25|t 當游標顯示此圖示時代表該玩家擁有角色資訊，可點擊右鍵互動。
 |cnGREEN_FONT_COLOR:備註: 此功能在戰鬥狀態停用。|r]=],
	["CO_CURSOR_TITLE"] = "滑鼠互動設定",
	["CO_CUSTOMIZATION"] = "自訂",
	["CO_DATE_FORMAT"] = "日期格式",
	["CO_GENERAL"] = "一般設定",
...
如果不要，語言選項將會在下次登入時變更。]=],
	...
	["CO_GENERAL_CONTRAST_LEVEL_MONOCHROMATIC"] = "黑白",
	["CO_GENERAL_CONTRAST_LEVEL_NONE"] = "無",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_HIGH"] = "非常高",
	["CO_GENERAL_CONTRAST_LEVEL_VERY_LOW"] = "非常低",
	...
	["CO_LOCATION_DISABLE_CLASSIC_PVP"] = "開啟PVP模式時不顯示位置",
	["CO_LOCATION_DISABLE_CLASSIC_PVP_TT"] = "當開啟PVP模式時，你將不會被其他玩家掃描到所在位置。此功能可以避免惡意騷擾者利用掃描功能追蹤到你。",
	...
	["CO_LOCATION_DISABLE_WAR_MODE_TT"] = "當開啟戰爭模式並且位於 |cff69CCF0聖域|r 外時，你將不會被其他玩家掃描到所在位置。此功能可以避免惡意騷擾者利用掃描功能追蹤到你。",
	["CO_LOCATION_SHOW_DIFFERENT_WAR_MODES"] = "顯示位於不同戰爭模式的玩家",
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER"] = "顯示OOC（脫離角色）的玩家",
	["CO_MAP_BUTTON"] = "地圖掃描鍵",
...
|cnWARNING_FONT_COLOR:當你的資料數量達到一定的極限值時，魔獸世界會自動清除所有資料，所以我們強烈建議你不要關閉此選項。|r]=],
	...
	["CO_RELATIONS_NEW_COLOR_TT"] = "此選項會調整關係的對應顏色。",
	["CO_RELATIONS_NEW_ERROR"] = "你必須填入關係的名字。",
	...
	["CO_TOOLBAR_VISIBILITY"] = "顯示設定",
	["CO_TOOLBAR_VISIBILITY_1"] = "永遠顯示",
	["CO_TOOLBAR_VISIBILITY_2"] = "僅在IC狀態時顯示",
	["CO_TOOLBAR_VISIBILITY_3"] = "永遠隱藏",
	["CO_TOOLBAR_VISIBILITY_HELP"] = [=[調整工具列會於何種情況下顯示。

你可以使用指令: |cnGREEN_FONT_COLOR:/trp3 switch toolbar|r 或右鍵點擊小地圖按鍵來強制開關工具列。]=],
	["CO_TOOLTIP"] = "提示欄設定",
	...
	["CO_TOOLTIP_RELATION_LINE"] = "顯示關係",
	["CO_TOOLTIP_RELATION_LINE_FULL"] = "顯示完整描述",
	["CO_TOOLTIP_RELATION_LINE_FULL_TT"] = "將關係資訊顯示於玩家與目標的提示欄中。",
	["CO_TOOLTIP_RELATION_LINE_HIDDEN_TT"] = "不要顯示任何關係資訊於提示欄中。",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE"] = "僅顯示名字",
	...
	["DB_STATUS_WU"] = "接受攀談互動",
	["DB_STATUS_WU_YES_TT"] = "你接受其他玩家主動上前與你交談互動。|n|n勾選此項會在你的提示欄中以圖標表示。",
	["DB_STATUS_XP"] = "角色扮演熟練度",
	["DB_STATUS_XP_NEWCOMER"] = "新人",
	["DB_STATUS_XP_NEWCOMER_GUIDE"] = "新人指導者",
	["DB_STATUS_XP_NEWCOMER_GUIDE_TT"] = "表示你願意協助新人，指導他們角色扮演。|n|n勾選此項會在你的提示欄中以圖標表示。",
	["DB_STATUS_XP_NEWCOMER_TT"] = "表示你是一位角色扮演新手。|n|n勾選此項會在你的提示欄中以圖標表示。",
	["DB_STATUS_XP_NORMAL"] = "休閒",
	["DB_STATUS_XP_NORMAL_TT"] = "表示你是一位休閒角色扮演玩家，沒有明確註明角色扮演的熟練程度。|n|n此選項不會在提示欄中顯示圖標。",
	["DB_STATUS_XP_VETERAN"] = "老手",
	["DB_STATUS_XP_VETERAN_TT"] = "表示你是一位角色扮演老手。|n|n此選項不會在提示欄中顯示圖標。",
	["DB_TUTO_1"] = [=[|cffffff00角色狀態|r 指示你是進入角色還是脫離角色扮演的狀態。

|cffffff00扮演程度|r 顯示你是菜鳥、老鳥還是志願的教學者。

|cff00ff00這些資訊都會在你的角色卡欄位中顯示。|r]=],
	["DEFAULT_GUILD_RANK"] = "成員",
	...
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON"] = "鎖定小地圖按鈕",
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON_HELP"] = "如勾選此項，小地圖按鈕將不會被拖曳移動。",
	["LAUNCHER_CONFIG_MENU_TITLE"] = "小地圖按鈕",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON"] = "重置小地圖按鈕位置",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON_HELP"] = "重置小地圖按鈕至預設位置。",
...
騎士、乳酪商、礦工、軍人、奧術師…]=],
	...
	["REG_PLAYER_COLOR_TT_COPY"] = "複製顏色",
	["REG_PLAYER_COLOR_TT_COPYNAME"] = "複製色碼",
	["REG_PLAYER_COLOR_TT_DEFAULTPICKER"] = "直接使用調色盤",
	["REG_PLAYER_COLOR_TT_DISCARD"] = "放棄顏色",
	["REG_PLAYER_COLOR_TT_OPTIONS"] = "顯示顏色選項",
	["REG_PLAYER_COLOR_TT_PASTE"] = "貼上顏色",
...
|cff00ff00%s|r.]=],
	...
	["REG_PLAYER_MISC_ADD_TOOLTIP"] = "此項資訊會 |cnGREEN_FONT_COLOR:顯示在你的提示欄|r。 ",
	["REG_PLAYER_MISC_PRESET_GUILD_NAME"] = "公會名稱",
	["REG_PLAYER_MISC_PRESET_GUILD_RANK"] = "公會階級",
	["REG_PLAYER_MISC_PRESET_PRONOUNS"] = "人稱代詞",
	["REG_PLAYER_MISC_PRESET_VOICE_REFERENCE"] = "聲線參考",
...
如果你不想以這種方式來向其他玩家展示您的角色，請不要勾選此欄，描述框將會完全隱藏。]=],
	...
	["REG_PLAYER_STYLE_DEATH_TT"] = "顯示此玩家是否接受 |cnGREEN_FONT_COLOR:角色死亡|r。",
	...
	["REG_PLAYER_STYLE_INJURY_TT"] = "顯示此玩家是否接受 |cnGREEN_FONT_COLOR:角色受到傷害|r。",
	["REG_PLAYER_STYLE_LOSSOFCONTROL"] = "允許角色失去控制",
	["REG_PLAYER_STYLE_LOSSOFCONTROL_TT"] = "顯示此玩家是否接受 |cnGREEN_FONT_COLOR:角色失去控制|r，例如 |cnGREEN_FONT_COLOR: 遭到暫時性監禁或者心靈控制|r。",
	["REG_PLAYER_STYLE_PERMI"] = "需要經過玩家許可",
	["REG_PLAYER_STYLE_ROMANCE"] = "允許角色之間發展戀愛關係",
	["REG_PLAYER_STYLE_ROMANCE_TT"] = "顯示此玩家是否接受 |cnGREEN_FONT_COLOR:角色與他人發展戀愛關係|r。",
...
例如 |c0000ff00瘦、胖或強壯…|r 或只是一般的身形。]=],
	...
	["REG_RELATION_BUSINESS_TT"] = "%1$s 和 %2$s 之間是生意上的關係。",
	["REG_RELATION_BUTTON_TT"] = "|cnGREEN_FONT_COLOR:關係: %s|r|n%s",
	["REG_RELATION_BUTTON_TT_ACTIONS"] = "顯示可執行的動作",
	["REG_RELATION_FAMILY"] = "家人",
	["REG_RELATION_FAMILY_TT"] = "%1$s 與 %2$s 的關係血濃於水。",
	["REG_RELATION_FRIEND"] = "友善",
	["REG_RELATION_FRIEND_TT"] = "%1$s 將 %2$s 視為朋友。",
	["REG_RELATION_LOVE"] = "愛戀",
	["REG_RELATION_LOVE_TT"] = "%1$s 正與 %2$s 陷入愛河！",
	["REG_RELATION_NEUTRAL"] = "中立",
	["REG_RELATION_NEUTRAL_TT"] = "%1$s 對 %2$s 沒什麼特別的感覺。",
	["REG_RELATION_NONE"] = "無",
	["REG_RELATION_NONE_TT"] = "%1$s 不認識 %2$s。",
	["REG_RELATION_TARGET"] = "變更關係",
	["REG_RELATION_UNFRIENDLY"] = "不友善",
	["REG_RELATION_UNFRIENDLY_TT"] = "看來 %1$s 不太喜歡 %2$s。",
...
TRP3.loc:RegisterNewLocale("zhTW", "繁體中文", L);
