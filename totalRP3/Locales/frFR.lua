...
L = {
	...
	["AUTOMATION_MODULE_SETTINGS_TITLE"] = "Automatisation",
...
Importer du contenu créé avec une version différente peut poser des soucis en cas d'incompatibilité entre les deux versions. Souhaitez-vous tout de même continuer ?]=],
	...
	["CM_OPT"] = "Option",
	["CM_OPTIONS"] = "Options",
	["CM_OPTIONS_ADDITIONAL"] = "Options supplémentaires",
	["CM_ORANGE"] = "Orange",
	["CM_PINK"] = "Rose",
	["CM_PLAY"] = "Jouer",
	["CM_PURPLE"] = "Violet",
...
(sans les " et avec un espace après le | )|r]=],
	...
	["CO_CURSOR_DISABLE_OOC_TT"] = "Désactiver les modifications du curseur quand votre status roleplay est |cnGREEN_FONT_COLOR:Hors RolePlay|r.",
...
|cnGREEN_FONT_COLOR:Note: Cette fonctionnalité est toujours désactivée durant un combat.|r]=],
	["CO_CURSOR_TITLE"] = "Interactions avec le curseur",
	["CO_CUSTOMIZATION"] = "Personnalisation",
...
|cnWARNING_FONT_COLOR:Il existe un bug dans WoW supprimant toutes les données sauvegardées si le fichier de sauvegarde atteint une certaine taille. Nous déconseillons donc fortement de désactiver totalement la purge.|r]=],
	...
	["CO_RELATIONS_DELETE_WARNING"] = "Êtes-vous sûr de vouloir supprimer la relation %s ?",
	...
	["CO_RELATIONS_NEW_COLOR_TT"] = "Ceci détermine la couleur de la relation.",
	["CO_RELATIONS_NEW_ERROR"] = "Vous devez entrer un nom pour la nouvelle relation.",
	...
	["CO_TARGETFRAME"] = "Cadre de la cible",
	...
	["CO_TOOLTIP_CLIENT_TT"] = "Affiche ou cache la version du client sur la ligne de notification.",
	...
	["CO_TOOLTIP_HIDE_ON_MODIFIED_NEVER"] = "Jamais",
	["CO_TOOLTIP_HIDE_ON_MODIFIER"] = "Cacher avec touche de modification",
	["CO_TOOLTIP_HIDE_ON_MODIFIER_TT"] = "Cache l'infobulle personnalisée lorsqu'une touche de modification telle que Ctrl ou Alt est appuyée.",
	...
	["CO_TOOLTIP_RELATION_LINE"] = "Afficher la relation",
	["CO_TOOLTIP_RELATION_LINE_FULL"] = "Description complète",
	["CO_TOOLTIP_RELATION_LINE_FULL_TT"] = "Affiche la description complète de la relation avec les noms du joueur et de la cible dans l'infobulle.",
	["CO_TOOLTIP_RELATION_LINE_HIDDEN_TT"] = "N'affiche pas d'information de relation sur une ligne de l'infobulle.",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE"] = "Nom uniquement",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE_TT"] = "Affiche le nom de la relation dans l'infobulle.",
	...
	["CO_TOOLTIP_SHOW_WORLD_CURSOR"] = "Afficher les infobulles sur les cibles indirectes",
	["CO_TOOLTIP_SHOW_WORLD_CURSOR_TT"] = "Affiche les infobulles RP personnalisées lorsque vous avez une cible indirecte. Cette fonctionnalité n'est généralement active que lors de l'utilisation d'un addon tel que ConsolePort.|n|nLes infobulles personnalisées ne seront pas affichées si le point d'accroche de l'infobulle est défini sur \"Afficher sur le curseur\".",
...
Cette fenêtre sera fermée à la copie.]=],
	...
	["CREDITS_THANK_YOU_SECTION_5"] = "{col:ffffff}Les logos et icône de la carte ont été réalisés par:{/col} %1$s|n{col:ffffff}Sidebar dice icon:{/col} %2$s",
	...
	["CURRENTLY_BUTTON_TT"] = "Affiche la fenêtre Actuellement, permettant de changer le statut Actuellement.",
	["CURRENTLY_COMMAND_HELP"] = "Ouvre la fenêtre Actuellement.",
	["CURRENTLY_TITLE"] = "Actuellement",
	...
	["DB_STATUS_CURRENTLY_OOC_TT"] = "Toute information importante vous concernant, en tant que joueur, ou hors du personnage.",
	["DB_STATUS_CURRENTLY_TT"] = "Tout ce qui est pertinent ou en train d'arriver à votre personnage.",
...
|cffff9900Note:|r Ceci ne change |cffff0000pas|r le langage de l'interface de Total RP 3. Cette option peut être trouvée dans la page de |cfffff569Paramètres avancés|r.]=],
	...
	["DB_STATUS_RP_IC_TT"] = "Cette sélection indique aux joueurs que vous jouez actuellement votre personnage et que toutes vos actions devraient être considérées comme telles.",
	["DB_STATUS_RP_OOC"] = "Hors du personnage",
	["DB_STATUS_RP_OOC_TT"] = "Cette sélection indique aux autres joueurs que vous êtes actuellement hors de votre personnage et qu'ils ne devraient pas prendre les actions de votre personnage en compte.|n|nCeci sera illustré par un indicateur rouge sur votre infobulle.",
	["DB_STATUS_WU"] = "Approchable",
	["DB_STATUS_WU_YES_TT"] = "Indique aux autres joueurs que vous être approchable.|n|nCeci sera illustré par une icône sur votre infobulle.",
	["DB_STATUS_XP"] = "Aptitude de jeu de rôle",
	["DB_STATUS_XP_NEWCOMER"] = "Débutant",
	["DB_STATUS_XP_NEWCOMER_GUIDE"] = "Guide pour débutants",
	["DB_STATUS_XP_NEWCOMER_GUIDE_TT"] = "Cette sélection indique aux joueurs débutants que vous êtes disposé à les aider.|n|nCeci sera illustré par une icône sur votre infobulle.",
	["DB_STATUS_XP_NEWCOMER_TT"] = "Cette sélection indique aux autres joueurs que vous être un rôliste débutant.|n|nCeci sera illustré par une icône sur votre infobulle.",
	["DB_STATUS_XP_NORMAL"] = "Occasionnel",
	["DB_STATUS_XP_NORMAL_TT"] = "Cette sélection indique aux autres joueurs que vous être un rôliste occasionnel sans expérience significative.|n|nCeci ne sera pas illustré par une icône sur votre infobulle.",
	["DB_STATUS_XP_VETERAN"] = "Vétéran",
	["DB_STATUS_XP_VETERAN_TT"] = "Cette sélection indique aux autres joueurs que vous considérez être un rôliste expérimenté.|n|nCeci ne sera pas illustré par une icône sur votre infobulle.",
...
|cff00ff00Cette information sera placée dans la bulle d'aide de votre personnage.|r]=],
	...
	["LAUNCHER_ACTION_STATUS"] = "Se mettre en RP/HRP",
	["LAUNCHER_ACTION_TOOLBAR"] = "Afficher/cacher la barre d'outils",
	...
	["LAUNCHER_CONFIG_MENU_TITLE"] = "Boutons",
...
{col:f2bf1a}{link*https://www.curseforge.com/wow/addons/total-rp-3-unit-frames*Télécharger sur CurseForge}{/col}]=],
	...
	["NAMEPLATES_CONFIG_ICON_SIZE_HELP"] = "Configure la taille des icones affichées sur les barres d'infos si l'option |cnGREEN_FONT_COLOR:Afficher icones|r est activée.",
...
Remplacer le contenu du profil %s avec les données importées ?]=],
	...
	["REG_COMPANION_ICON"] = "Icône de familier",
	["REG_COMPANION_ICON_TT"] = "Choisissez une icône qui représente votre familier.",
	...
	["REG_COMPANION_NAME_COLOR_TT"] = "La couleur du nom de votre familier.",
...
Ces outils vous permettent aussi d'insérer |cffffff00 des images, des icônes ou un lien vers un site web externe|r.]=],
	...
	["REG_COMPANION_TF_PROFILE_SPEECH"] = "Dialogue de familier",
	["REG_COMPANION_TF_PROFILE_SPEECH_TT"] = "Ouvre la fenêtre de dialogues de PNJ avec le nom de votre familier rempli.",
...
|cff00ff00%s|r]=],
	...
	["REG_LIST_CHAR_TITLE"] = "Personnages",
...
|cff00ff00%s|r]=],
	["REG_LIST_CHAR_TUTO_FILTER"] = [=[Ces filtres sont appliqués à la liste des profils de personnage ci-dessus.

Le |cnGREEN_FONT_COLOR:filtre de nom|r filtre la liste de profils de personnage par le nom (RP ou HRP) fourni.

Le |cnGREEN_FONT_COLOR:filtre de guilde|r filtre la liste de profils de personnage par le nom de guilde HRP fourni.

Le |cnGREEN_FONT_COLOR:filtre "Ce royaume uniquement"|r filtre la liste de profils de personnage pour ne montrer que les profils de personnages sur votre royaume actuel.

Le |cnGREEN_FONT_COLOR:filtre "Avec notes uniquement"|r filtre la liste de profils de personnage pour ne montrer que les profiles avec une note attachée.]=],
	["REG_LIST_CHAR_TUTO_LIST"] = [=[Les cases à cocher dans la |cnGREEN_FONT_COLOR:première colonne|r vous permettent de sélectionner plusieurs personnages sur lesquels appliquer des actions avec le bouton en haut à gauche.

La |cnGREEN_FONT_COLOR:seconde colonne|r affiche le nom du personnage.

La |cnGREEN_FONT_COLOR:troisième colonne|r affiche la relation entre ces personnages et votre personnage actuel.

La |cnGREEN_FONT_COLOR:quatrième colonne|r affiche la date à laquelle Total RP 3 a reçu le profil en dernier.

La |cnGREEN_FONT_COLOR:cinquième colonne|r affiche le type de profil (Total RP 3, MyRoleplay, etc.).

La |cnGREEN_FONT_COLOR:dernière colonne|r affiche divers indicateurs (ignoré ..etc.).]=],
	["REG_LIST_FILTERS"] = "Filtres",
	["REG_LIST_FILTERS_APPLY"] = "Appliquer les filtres",
	["REG_LIST_FILTERS_CLEAR"] = "Effacer les filtres",
	["REG_LIST_FLAGS"] = "Marqueurs",
	["REG_LIST_GUILD"] = "Guilde du personnage",
	["REG_LIST_IGNORE_EMPTY"] = "Pas de personnage ignoré",
	["REG_LIST_IGNORE_REMOVE"] = "Supprimer de la liste ignorée",
	["REG_LIST_IGNORE_TITLE"] = "Ignorés",
...
|cffffff00Cliquer pour supprimer de la liste des ignorés]=],
	...
	["REG_LIST_PETS_TITLE"] = "Compagnons",
...
Si vous ne souhaitez pas que TRP3 soit votre addon MSP et ne voulez plus voir cette alerte à nouveau, vous pouvez désactiver le module Mary Sue Protocol dans les paramètres TRP3 -> Statut des modules.]=],
	...
	["REG_PLAYER_ABOUT_UNMUSIC"] = "|cffff9900Thème inconnu|r",
...
- Ou un adjectif (Jeune, Mature, Adulte, Vénérable, etc.).]=],
	["REG_PLAYER_ALERT_HEAVY_SMALL"] = [=[|cnWARNING_FONT_COLOR:La taille de votre profil est plutôt importante.|r
Vous devriez la réduire.]=],
...
Chevalier, Pyrotechnicien, Nécromant, Tireur d'élite, Arcaniste ...]=],
	...
	["REG_PLAYER_CONVERT"] = "Convertir en |cnGREEN_FONT_COLOR:champ personnalisé|r",
	["REG_PLAYER_CONVERT_WARNING"] = "Cette information |cnWARNING_FONT_COLOR:ne sera plus affichée dans votre infobulle|r.",
...
|cff00ff00Note: Si ce nom est déjà utilisé par un autre groupe, ce dernier sera remplacé.]=],
	...
	["REG_PLAYER_GLANCE_CONFIG"] = "Ces emplacements peuvent être utilisés pour définir des informations importantes et concises à propos de ce personnage.",
	["REG_PLAYER_GLANCE_CONFIG_EDIT"] = "Configurer l'emplacement",
	["REG_PLAYER_GLANCE_CONFIG_PRESETS"] = "Charger/enregistrer un coup d'œil",
	["REG_PLAYER_GLANCE_CONFIG_REORDER"] = "Réorganiser les emplacements",
	["REG_PLAYER_GLANCE_CONFIG_TOGGLE"] = "Activer/Désactiver l'emplacement",
...
|cff00ff00%s|r.]=],
	["REG_PLAYER_HERE_HOME_TT_CURRENT"] = "Utiliser la position actuelle comme coordonnées de résidence",
	["REG_PLAYER_HERE_HOME_TT_DISCARD"] = "Effacer les coordonnées de la résidence",
	["REG_PLAYER_HERE_TT"] = "Utiliser votre position actuelle",
...
|rVous pouvez optionnellement entrer la raison de cette action. Cette note est personnelle et vous servira de rappel.]=],
	...
	["REG_PLAYER_MISC_ADD_TOOLTIP"] = "Cette information sera |cnGREEN_FONT_COLOR:affichée dans votre infobulle|r.",
	...
	["REG_PLAYER_PSYCHO_DECEITFUL"] = "Trompeur",
	["REG_PLAYER_PSYCHO_FORGIVING"] = "Indulgent",
	["REG_PLAYER_PSYCHO_GENTLE"] = "Miséricordieux",
	["REG_PLAYER_PSYCHO_IMPULSIVE"] = "Impulsif",
	["REG_PLAYER_PSYCHO_LAWFUL"] = "Loyal",
	["REG_PLAYER_PSYCHO_LEFTICON_TT"] = "Régler l'icône d'attribut de gauche",
	["REG_PLAYER_PSYCHO_LUSTFUL"] = "Luxurieux",
	["REG_PLAYER_PSYCHO_PARAGON"] = "Parangon",
	["REG_PLAYER_PSYCHO_PERSONAL"] = "Traits personnels",
	["REG_PLAYER_PSYCHO_RATIONAL"] = "Rationnel",
	["REG_PLAYER_PSYCHO_RENEGADE"] = "Pragmatique",
	["REG_PLAYER_PSYCHO_RIGHTICON_TT"] = "Régler l'icône de l'attribut de droite.",
	["REG_PLAYER_PSYCHO_SELFISH"] = "Egoïste",
	["REG_PLAYER_PSYCHO_SOCIAL"] = "Traits sociaux",
	["REG_PLAYER_PSYCHO_SPINELESS"] = "Couard",
	["REG_PLAYER_PSYCHO_SUPERSTITIOUS"] = "Pieux",
	["REG_PLAYER_PSYCHO_TRUTHFUL"] = "Sincère",
	["REG_PLAYER_PSYCHO_VALOROUS"] = "Valeureux",
	["REG_PLAYER_PSYCHO_VINDICTIVE"] = "Rancunier",
	...
	["REG_PLAYER_REORDER"] = "Réordonner",
	["REG_PLAYER_REORDER_TT"] = "Réordonner ce champ.",
	["REG_PLAYER_RESIDENCE"] = "Lieu de résidence",
	["REG_PLAYER_RESIDENCE_SHOW"] = "Coordonnées de résidence",
	["REG_PLAYER_RESIDENCE_SHOW_TT"] = "Afficher sur la carte",
...
Si vous ne voulez pas indiquer la personnalité de votre personnage ainsi, laissez ce bouton décoché et le panneau de personnalité restera complètement caché.]=],
	["REG_PLAYER_STATUS"] = "Statut",
	["REG_PLAYER_STYLE_CRIME"] = "Accepte l'activité criminelle",
	["REG_PLAYER_STYLE_CRIME_TT"] = "Indique si ce joueur est comfortable pour que |cnGREEN_FONT_COLOR:leur personnage soit soumis à une activité criminelle|r, telle qu'une aggression.",
	["REG_PLAYER_STYLE_DEATH"] = "Accepte la mort",
	["REG_PLAYER_STYLE_DEATH_TT"] = "Indique si ce joueur est comfortable pour que |cnGREEN_FONT_COLOR:leur personnage puisse mourir|r.",
	...
	["REG_PLAYER_STYLE_GUILD_TT"] = "Indique le |cnGREEN_FONT_COLOR:statut RP de l'appartenance de ce personnage à une guilde|r.",
...
Chaque cadre est caractérisé par une |cffffff00icône, un arrière-plan et un texte|r. Notez que vous pouvez utiliser quelques balises de texte dans ces cadres, comme celles de couleur, ou d'icônes.]=],
	["REG_PLAYER_TUTO_FORMATTING_TOOLS"] = "Les outils de formatage vous donnent accès à |cnGREEN_FONT_COLOR:plusieurs paramètres de mise en page|r (les tailles de texte, les couleurs, ou les alignements). Vous pouvez aussi |cnGREEN_FONT_COLOR:insérer des images, des icônes ou des liens vers des sites web externes|r.",
	["REG_PLAYER_WALKUP_TT"] = "Ce joueur accepte d'être approché par d'autres joueurs.",
...
Il pourrait par exemple être |c0000ff00mince, gros ou musclé...|r Ou tout simplement être dans la norme !]=],
	...
	["REG_RELATION_BUSINESS_TT"] = "%1$s et %2$s sont dans une relation d'affaires.",
	["REG_RELATION_BUTTON_TT"] = "|cnGREEN_FONT_COLOR:Relation: %s|r|n%s",
	["REG_RELATION_BUTTON_TT_ACTIONS"] = "Afficher les actions possibles",
	["REG_RELATION_FAMILY"] = "Famille",
	["REG_RELATION_FAMILY_TT"] = "%1$s partage des liens du sang avec %2$s.",
	["REG_RELATION_FRIEND"] = "Amical",
	["REG_RELATION_FRIEND_TT"] = "%1$s considère %2$s comme un ami.",
	["REG_RELATION_LOVE"] = "Amour",
	["REG_RELATION_LOVE_TT"] = "%1$s est amoureux de %2$s !",
	["REG_RELATION_NEUTRAL"] = "Neutre",
	["REG_RELATION_NEUTRAL_TT"] = "%1$s n'a pas d'affection particulière pour %2$s.",
	["REG_RELATION_NONE"] = "Aucune",
	["REG_RELATION_NONE_TT"] = "%1$s ne connaît pas %2$s.",
	["REG_RELATION_TARGET"] = "Changer la relation",
	["REG_RELATION_UNFRIENDLY"] = "Hostile",
	["REG_RELATION_UNFRIENDLY_TT"] = "%1$s n'aime vraiment pas %2$s.",
...
|cnWARNING_FONT_COLOR:Veuillez noter que cette fonctionnalité n'est PAS pour signaler des profils RP qui vous semblent de faible qualité ou pour chercher à nuire à un joueur. Tout abus de cette fonctionnalité pourrait entraîner des sanctions.|r]=],
	...
	["REG_TT_NOTIF_LONG_TT"] = "Le contenu de la description de ce profil a changé depuis votre dernière visite.",
	["REG_TT_NOTIF_TT"] = "Le contenu de cette section a changé depuis votre dernière visite.",
...
|cffff9900/trp3 status toggle|r change votre statut pour le statut opposé.]=],
	...
	["TB_SWITCH_CAPE_OFF"] = "Cape: |cffff0000Masquée|r",
	["TB_SWITCH_CAPE_ON"] = "Cape: |cffff0000Affichée|r",
	["TB_SWITCH_HELM_1"] = "Afficher le casque",
	["TB_SWITCH_HELM_2"] = "Masquer le casque",
	["TB_SWITCH_HELM_OFF"] = "Casque: |cffff0000Masqué|r",
	["TB_SWITCH_HELM_ON"] = "Casque: |cffff0000Affiché|r",
	["TB_SWITCH_PROFILE"] = "Passer à un autre profil",
	["TB_SWITCH_TOOLBAR"] = "Afficher/masquer la barre d'outils",
	["TB_TOOLBAR"] = "Barre d'outils",
	["TF_CHAR_THEME"] = "Thème du personnage",
	["TF_CHAR_THEME_PLAY"] = "Jouer %s",
...
|cffff7700Vous pouvez entrer optionnellement la raison d'ignorer le joueur ci-dessous. C'est une note personnelle, elle ne sera vue par personne d'autre et servira de rappel.|r]=],
	...
	["TF_IGNORE_TT"] = "Cache le profil de ce personnage et ne partage plus votre profil ou position sur la carte avec eux.",
	["TF_MORE_OPTIONS"] = "Plus d'options",
...
{col:ffffff}Merci à Horionne pour nous avoir envoyé son exemplaire du Gamer Culte Online #14 qui contient un article sur Total RP.{/col}]=],
	...
	["TT_ELVUI_SKIN_ENABLE_TOOLBAR_FRAME"] = "Apparence de la barre d'outils",
	["TT_ELVUI_SKIN_ENABLE_TOOLTIPS"] = "Apparence des infobulles",
	["UI_BKG"] = "Arrière-plan %s",
	["UI_BKG_BROWSER"] = "Navigateur d'arrière-plans",
	["UI_BKG_BUTTON"] = "Modifier arrière-plan",
	...
	["UI_COMPANION_BROWSER_RENAME_WARNING"] = "|cffff0000Attention:|r Il est fortement recommandé de ne lier les profils de familiers qu'à des familiers renommés.",
	["UI_FILTER"] = "Filtre",
	...
	["UI_ICON_COPYNAME"] = "Copier nom de l'icône",
	["UI_ICON_OPENBROWSER"] = "Ouvrir le navigateur d'icônes",
	["UI_ICON_OPTIONS"] = "Afficher options d'icône",
	["UI_ICON_PASTE"] = "Coller icône",
...
Total RP n'est pas responsable du contenu des liens partagés.]=],
	...
	["UI_TUTO_BUTTON_TT"] = "Afficher ou masquer le mode tutoriel",
	...
	["UNIT_POPUPS_CONFIG_MENU_TITLE"] = "Menus d'unités",
	...
	["UNIT_POPUPS_CONFIG_PAGE_TEXT"] = "Menus d'unités",
