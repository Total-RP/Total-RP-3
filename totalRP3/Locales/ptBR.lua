...
L = {
	...
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_APPLIED"] = "Equipamento trocado para %s.",
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_DESCRIPTION"] = "Vestir um conjunto de equipamento automaticamente.",
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_HELP"] = "O nome do conjunto de equipamento precisa ser igual ao nome do conjunto guardado no gerenciador de equipamento no painel do personagem.",
	["AUTOMATION_ACTION_CHARACTER_EQUIPSET_INVALID"] = "Falha em trocar o conjunto de equipamento: conjunto %s não existe.",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST"] = "Alternar o local da transmissão",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_DESCRIPTION"] = "Alterna se você aparecerá ou não nas varreduras de mapa de outros jogadores.",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_DISABLED"] = "Transmissão de escaneamento de mapa local foi desativado.",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_ENABLED"] = "Transmissão de escaneamento de mapa local foi ativado.",
	["AUTOMATION_ACTION_MAP_SCANS_BROADCAST_ERROR"] = "Falha em alternar local da Transmissão de escaneamento de mapa: %s",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE"] = "Alternar customizações",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_DESCRIPTION"] = "Alterna se as plaquetas de nomes dos jogadores serão personalizados ou não.",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_DISABLED"] = "Customizações de Plaquetas de nomes Foram desativados.",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_ENABLED"] = "Customizações de Plaquetas de nomes Foram ativados.",
	["AUTOMATION_ACTION_NAMEPLATES_ENABLE_ERROR"] = "Falha em alternar customizações de Plaquetas de nomes: %s",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS"] = "Alterna plaquetas de nome de NPC's amigáveis",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_DESCRIPTION"] = "Alterna se as plaquetas de nomes de NPC's amigáveis ou não serão mostradas.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_DISABLED"] = "Plaquetas de nomes de NPC's Amigáveis foram desativados.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_ENABLED"] = "Plaquetas de nomes de NPC's Amigáveis foram Ativados.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDLY_NPCS_ERROR"] = "Falha em alternar  plaquetas de nome de NPC's amigávéis: %s",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS"] = "Alternar plaquetas de nomes de jogadores amigáveis.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_DESCRIPTION"] = "Alterna se as plaquetas de nomes de NPC's amigáveis ou não serão mostradas para outros jogadores.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_DISABLED"] = "Plaquetas de nomes de jogadores foram desativadas.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_ENABLED"] = "Plaquetas de nomes de jogadores foram ativadas.",
	["AUTOMATION_ACTION_NAMEPLATES_SHOW_FRIENDS_ERROR"] = "Falha em alternar plaquetas de nomes de jogadores: %s",
	["AUTOMATION_ACTION_OPTIONS_HELP"] = "A condição macro deve avaliar para qualquer uma das seguintes opções: %s.",
	["AUTOMATION_ACTION_PROFILE_CHANGE"] = "Trocar Perfil",
	["AUTOMATION_ACTION_PROFILE_CHANGE_DESCRIPTION"] = "Muda o seu atual Perfil selecionado.",
	["AUTOMATION_ACTION_PROFILE_CHANGE_ERROR"] = "Falha em mudar os perfis: %s",
	["AUTOMATION_ACTION_PROFILE_CHANGE_HELP"] = "O nome do perfil para o qual você deseja alternar será comparado sem diferenciação de maiúsculas e minúsculas e precisa ser apenas uma correspondência parcial. Para uma correspondência exata, coloque o nome do perfil entre aspas (\"\").",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS"] = "Trocar status de roleplay.",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_CHANGED_IC"] = "Status de roleplay foi trocado para \"No personagem\".",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_CHANGED_OOC"] = "Status de roleplay foi trocado para \"Fora do personagem\".",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_DESCRIPTION"] = "Troca o status atual de roleplay (No personagem e Fora do personagem).",
	["AUTOMATION_ACTION_ROLEPLAY_STATUS_ERROR"] = "Falha em trocar o status de roleplay: %s",
	["AUTOMATION_CATEGORY_MAP_SCANS"] = "Escaneamentos de mapa",
	["AUTOMATION_CATEGORY_PROFILE"] = "Perfil",
	["AUTOMATION_CONDITION_ROLEPLAY_STATUS_ERROR"] = "Falha em checar a condição de \"status de RP\"",
	["AUTOMATION_ERROR_INVALID_OPTION"] = "Opção inválida '%1$s' (esperado qualquer da seguinte: %s)",
	["AUTOMATION_ERROR_INVALID_PROFILE"] = "Impossível encontrar o perfil chamado '%s'",
	["AUTOMATION_MODULE_DESCRIPTION"] = "Permite configurar ações como trocas de perfil e mudanças de status de interpretação para que ocorram automaticamente.",
	["AUTOMATION_MODULE_NAME"] = "Automação",
	["AUTOMATION_MODULE_SETTINGS_HELP"] = "Selecione uma ação no menu suspenso abaixo e insira uma sequência de condições de macro no campo de texto exibido.",
	["AUTOMATION_MODULE_SETTINGS_TITLE"] = "Automação",
	["AUTOMATION_PROFILE_COPY"] = "Copiar perfil",
	["AUTOMATION_PROFILE_COPY_DIALOG_BUTTON1"] = "Copiar",
	["AUTOMATION_PROFILE_COPY_DIALOG_TITLE"] = "Você tem certeza que quer substituir todas as regras de automação no perfil |W|cnGREEN_FONT_COLOR:%s|r|w com as regras do perfil |W|cnGREEN_FONT_COLOR:%s|r|w?",
	["AUTOMATION_PROFILE_COPY_HELP"] = "Copia todas as regras deste perfil no perfil atualmente ativado.|n|n Isto será |cnRED_FONT_COLOR:  Uma susbistuição irreversível|r Todas as regras configuradas no atual perfil.",
	["AUTOMATION_PROFILE_CREATE"] = "Criar perfil",
	["AUTOMATION_PROFILE_CREATE_DIALOG_BUTTON1"] = "Criar",
	["AUTOMATION_PROFILE_CREATE_DIALOG_TITLE"] = "Coloque o nome para o novo perfil de automação.",
	["AUTOMATION_PROFILE_CREATE_HELP"] = "Cria um novo perfil.|n|nperfis podem ser usados para criar um conjunto de regras específicos de um personagem para o perfil de automação.",
	["AUTOMATION_PROFILE_DELETE"] = "Deletar perfil",
	["AUTOMATION_PROFILE_DELETE_DIALOG_TITLE"] = [=[Você tem certeza que deseja apagar o perfil
|W|cnGREEN_FONT_COLOR:%s|r|w?]=],
	["AUTOMATION_PROFILE_DELETE_HELP"] = [=[Deletar este perfil.|n|n istó será um |cnRED_FONT_COLOR:Processo|r Irreversível;
Perfis deletados não podem ser restaurados.]=],
	["AUTOMATION_PROFILE_ENABLE"] = "Ativar perfil",
	["AUTOMATION_PROFILE_ENABLE_HELP"] = "Ativa este perfil para o personagem atual.",
	["AUTOMATION_PROFILE_RESET"] = "Resetar perfil",
	["AUTOMATION_PROFILE_RESET_DIALOG_TITLE"] = [=[Tem certeza que você quer resetar todas as regras de automação no perfil
|W|cnGREEN_FONT_COLOR:%s|r|w?]=],
	["AUTOMATION_PROFILE_RESET_HELP"] = [=[Reseta todas as regras guardadas no perfil atual ativo.|n|nIsso irá
|cnRED_FONT_COLOR: Deletar Irreversivelmente|r Todas regras configuradas no atual perfil.]=],
	["AUTOMATION_STATE_IC"] = "NP",
	["AUTOMATION_STATE_OOC"] = "FP",
	["AUTOMATION_STATE_UNSET"] = "Sem mudança",
	["AUTOMATION_TEST_BUTTON"] = "Condição de teste",
	["AUTOMATION_TEST_HELP"] = "Executa a condição da macro fornecida, imprimindo a opção que ela deve selecionar no quadro do chat.",
	["AUTOMATION_TEST_OUTPUT"] = "Resultado do teste de condição: %s",
...
|cffff9900Se você não sabe a senha, você não poderá usar opções como localização de jogadores no mapa.]=],
	["BW_COLOR_CODE_HEX"] = "Código Hex",
	["BW_COLOR_PRESET_DELETE"] = "Deletar cor",
	["BW_COLOR_PRESET_RENAME"] = "Renomear cor",
	["BW_COLOR_PRESET_SAVE"] = "Salvar cor atual ",
	["BW_COLOR_PRESET_SAVE_AS_CUSTOM"] = "Salvar como uma pré-definição customizada de cor.",
	["BW_COLOR_PRESET_SELECT"] = "Selecionar cor",
	["BW_COLOR_PRESET_TITLE"] = "Cores predefinidas ",
	["BW_COLOR_UNREADABLE"] = "Aviso de legibilidade",
	["BW_COLOR_UNREADABLE_CLICK"] = "Usar cores recomendadas",
	["BW_COLOR_UNREADABLE_TT"] = "Esta cor pode ser |cnWARNING_FONT_COLOR:Automaticamente ajustada|r quando mostrada como dificil de ler em fundos escuros, como em dicas.|n|nUma |cnGREEN_FONT_COLOR:Cor alternativa recomendada|r é mostrada em baixo a direita da Preview.",
...
Importar conteúdo vindo de uma versão diferente pode causar problemas em casos de incompatibilidade. Deseja prosseguir mesmo assim? ]=],
	...
	["CM_CMD"] = "Comando",
	["CM_COLOR"] = "Cor",
	["CM_COPY_TO_CLIPBOARD"] = "Copiar para área de transferência",
	["CM_COPY_URL"] = "Copiar Link",
	["CM_CTRL"] = "Ctrl",
	["CM_CTRL_MAC"] = "Comando",
	["CM_CYAN"] = "Ciano",
	["CM_DELETE"] = "Deletar",
	...
	["CM_OPT"] = "Opção",
	["CM_OPTIONS"] = "Opções",
	["CM_OPTIONS_ADDITIONAL"] = "Opções adicionais",
	["CM_ORANGE"] = "Laranja",
	["CM_PINK"] = "Rosa",
	["CM_PLAY"] = "Reproduzir",
	["CM_PURPLE"] = "Roxo",
	...
	["CM_RESIZE_RESET_TT"] = "Resetar para o tamanho padrão",
	...
	["CO_BARFRAME_BUTTONSVISIBILITY"] = "Visibilidade do botão",
...
(sem aspas e com espaço após a barra)|r]=],
	...
	["CO_DATE_FORMAT_HELP"] = "Linha de formato usada para linhas de data/hora no complemento.|n|nSe deixado em branco, isso exibirá linhas de data/hora em um formato apropriado para a localidade configurada do complemento.|n|nOs seguintes especificadores de formato são suportados:|n|n%1$s|n|nTodos os outros caracteres são tratados literalmente.",
	["CO_DATE_FORMAT_SPEC_a"] = "%1$s: Nome semanal abreviado (%2$s)",
	["CO_DATE_FORMAT_SPEC_A"] = "%1$s: Nome semanal completo (%2$s)",
	["CO_DATE_FORMAT_SPEC_b"] = "%1$s: Nome mensal Abreviado (%2$s)",
	["CO_DATE_FORMAT_SPEC_B"] = "%1$s: Nome mensal completo (%2$s)",
	["CO_DATE_FORMAT_SPEC_d"] = "%1$s: Dia do mês (%2$s)",
	["CO_DATE_FORMAT_SPEC_ESC"] = "%1$s: O personagem literal '%%'",
	["CO_DATE_FORMAT_SPEC_H"] = "%1$s: Hora usando o relógio de 24 horas (%2$s)",
	["CO_DATE_FORMAT_SPEC_I"] = "%1$s: Hora usando o relógio de 12 horas (%2$s)",
	["CO_DATE_FORMAT_SPEC_m"] = "%1$s: Mês (%2$s)",
	["CO_DATE_FORMAT_SPEC_M"] = "%1$s: Minuto (%2$s)",
	["CO_DATE_FORMAT_SPEC_p"] = "%1$s: Ou 'Manhã' ou 'Tarde' (%2$s)",
	["CO_DATE_FORMAT_SPEC_S"] = "%1$s: Segundo (%2$s)",
	["CO_DATE_FORMAT_SPEC_y"] = "%1$s: Ano em dois dígitos (%2$s)",
	["CO_DATE_FORMAT_SPEC_Y"] = "%1$s: Ano completo (%2$s)",
...
Se não recarregar, a linguagem será alterada na próxima vez que conectar.]=],
	...
	["CO_GENERAL_CONTRAST_LEVEL"] = "Nível de contraste da cor",
	["CO_GENERAL_CONTRAST_LEVEL_HELP"] = "Controla o quão agressivamente as cores personalizadas serão ajustadas para legibilidade em fundos escuros.|n|nA configuração 'Baixo' é o padrão recomendado e geralmente afetará apenas cores muito escuras.",
	...
	["CO_GENERAL_CONTRAST_LEVEL_MONOCHROMATIC"] = "Monocromático",
	...
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE"] = "Desativar mensagem de boas vindas",
	["CO_GENERAL_DISABLE_WELCOME_MESSAGE_HELP"] = "Desativa a mensagem de boas-vindas exibida no quadro de bate-papo no login.",
	...
	["CO_LOCATION_SHOW_OUT_OF_CHARACTER_TT"] = "Se marcado, mostre os marcadores do mapa para todos os jogadores marcados como fora do personagem.",
...
|cff00ff00Lembrete: Você pode abrir o Total RP 3 usando /trp3 switch main|r]=],
	...
	["CO_MODULES_STATUS_6"] = "Desativado devido a conflitos",
	["CO_MODULES_SUPPORTS_HOTRELOAD"] = "Este módulo suporta recarga quente.",
...
|cnWARNING_FONT_COLOR:Há um bug no WoW que perde todos os dados salvos quando atinge um certo limite. Recomendamos evitar desativar o sistema de expurgo.|r]=],
	...
	["CO_TOOLBAR_VISIBILITY_HELP"] = "Configura as condições sob as quais a barra de ferramentas deve ser exibida.|n|nA visibilidade da barra de ferramentas pode ser forçada a ser alternada executando o comando |cnGREEN_FONT_COLOR:/trp3 switch toolbar|r slash ou clicando com o botão direito do mouse no botão do minimapa.",
	["CO_TOOLTIP"] = "Tooltip",
	...
	["CO_TOOLTIP_CLIENT_TT"] = "Alterna a parte da versão do cliente da linha de notificação.",
	...
	["CO_TOOLTIP_GUILD_SHOW_WITH_ALL"] = "Mostrar tudo",
	["CO_TOOLTIP_GUILD_SHOW_WITH_CUSTOM"] = "Mostrar customizados",
	["CO_TOOLTIP_GUILD_SHOW_WITH_ORIGINAL"] = "Mostrar original",
	["CO_TOOLTIP_GUILD_TT"] = "Personaliza como a associação à guilda é exibida na dica de ferramenta.",
	["CO_TOOLTIP_GUILD_TT_HIDDEN"] = "Não mostra nenhuma associação de guilda na dica de ferramenta.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ALL"] = "Exibe as associações de guilda originais e personalizadas em linhas separadas na dica de ferramenta.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_CUSTOM"] = "Exibe a filiação à guilda na dica de ferramenta, substituindo o nome ou a classificação, se personalizado no perfil do jogador.",
	["CO_TOOLTIP_GUILD_TT_SHOW_WITH_ORIGINAL"] = "Exibe a filiação à guilda na dica de ferramenta, mas não substitui o nome ou a classificação se personalizados no perfil dos jogadores.",
	...
	["CO_TOOLTIP_HIDE_ON_MODIFIER"] = "Ocultar na tecla de modificar",
	["CO_TOOLTIP_HIDE_ON_MODIFIER_TT"] = "Oculte a dica de ferramenta personalizada enquanto uma tecla modificadora, como Ctrl ou Alt, for pressionada.",
	...
	["CO_TOOLTIP_MAIN_COLOR"] = "Cor do texto principal",
	["CO_TOOLTIP_MAIN_COLOR_HELP"] = "A cor usada na dica de ferramenta para exibir texto como corrida, nível e cabeçalhos atuais e OOC.",
	...
	["CO_TOOLTIP_RELATION_LINE_FULL_TT"] = "Exibe a descrição completa da relação com os nomes do jogador e do alvo na dica de ferramenta.",
	["CO_TOOLTIP_RELATION_LINE_HIDDEN_TT"] = "Não exibir nenhuma informação de relação em uma linha na dica de ferramenta.",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE"] = "Mostrar somente o nome",
	["CO_TOOLTIP_RELATION_LINE_SIMPLE_TT"] = "Exibe o nome da relação na dica de ferramenta.",
	["CO_TOOLTIP_RELATION_TT"] = "Ajustar a borda da tela de informações do personagem para a cor do relacionamento",
	["CO_TOOLTIP_SECONDARY_COLOR"] = "Cor de texto Secundaria",
	["CO_TOOLTIP_SECONDARY_COLOR_HELP"] = "A cor usada na dica de ferramenta para exibir subtexto secundário, como nomes de reinos e guildas, conteúdo atual e OOC, e informações de zona ou saúde.",
	["CO_TOOLTIP_SHOW_WORLD_CURSOR"] = "Mostrar dicas de ferramentas para unidades de alvo suave",
	["CO_TOOLTIP_SHOW_WORLD_CURSOR_TT"] = "Exibe dicas de ferramentas personalizadas para a interpretação quando você adquire um alvo fácil. Este recurso normalmente só entra em vigor ao usar um complemento como o ConsolePort..|n|nDicas de ferramentas personalizadas não serão exibidas se o ponto de ancoragem da dica de ferramenta estiver definido como \"Mostrar no cursor\".",
	...
	["CO_TOOLTIP_TITLE_COLOR"] = "Cor do texto de Título",
	["CO_TOOLTIP_TITLE_COLOR_HELP"] = "A cor usada na dica de ferramenta para exibir títulos completos dos personagens.",
	["CO_TOOLTIP_USE"] = "Usar tela de informações de personagens/companheiros",
	["CO_TOOLTIP_VOICE_REFERENCE"] = "Mostrar preferência de Voz",
...
|cff00ff00Use o mesmo comando novamente (|cff999999/trp3 stash|cff00ff00) para restaurar seus dados.|r]=],
	...
	["COPY_URL_POPUP_TEXT"] = "Você pode copiar este link usando o atalho de teclado %s e depois colá-lo no seu navegador usando o atalho %s.",
	...
	["CURRENTLY_BUTTON_TT"] = "Abra o quadro Atualmente, permitindo que você altere seu status atual.",
	["CURRENTLY_COMMAND_HELP"] = "Abra o quadro Atualmente.",
	...
	["DB_STATUS_CURRENTLY_OOC_TT"] = "Qualquer coisa importante sobre você, como jogador ou sobre seu personagem.",
	["DB_STATUS_CURRENTLY_TT"] = "Qualquer coisa que esteja acontecendo atualmente ou seja relevante para seu personagem.",
	...
	["DB_STATUS_RP_IC_TT"] = "Esta seleção indicará aos outros jogadores que você está atualmente no personagem e que todas as suas ações devem ser consideradas como tal.",
	["DB_STATUS_RP_OOC"] = "Não interpretando",
	["DB_STATUS_RP_OOC_TT"] = "Esta seleção indicará aos outros jogadores que você está fora do personagem e que eles não devem levar em consideração as ações do seu personagem.|n|nIsso será mostrado como um aviso vermelho na sua dica de ferramenta.",
	["DB_STATUS_WU"] = "Fácil de caminhar",
	["DB_STATUS_WU_YES_TT"] = "Diz aos outros jogadores que você não se importa que eles se aproximem de você.|n|nIsso será mostrado como um ícone na sua dica de ferramenta.",
	["DB_STATUS_XP"] = "Proficiência em Roleplay",
	["DB_STATUS_XP_NEWCOMER"] = "Recém-chegado/a",
	["DB_STATUS_XP_NEWCOMER_GUIDE"] = "Guia do Recém-chegado/a",
	["DB_STATUS_XP_NEWCOMER_GUIDE_TT"] = "sua seleção indica aos jogadores iniciantes que você está disposto a ajudá-los.|n|nIsso será mostrado como um ícone na sua dica de ferramenta.",
	["DB_STATUS_XP_NEWCOMER_TT"] = "Esta seleção indicará aos outros jogadores que você é um RPGista iniciante.|n|nIsso será mostrado como um ícone na sua dica de ferramenta.",
	["DB_STATUS_XP_NORMAL"] = "Casual",
	["DB_STATUS_XP_NORMAL_TT"] = "Esta seleção indicará aos outros jogadores que você é um jogador casual sem nenhum nível de experiência específico.|n|nIsso não mostrará nenhum ícone específico na sua dica de ferramenta.",
	["DB_STATUS_XP_VETERAN"] = "Veterano",
	["DB_STATUS_XP_VETERAN_TT"] = "Esta seleção indicará aos outros jogadores que você é um jogador veterano .|n|nIsso não mostrará nenhum ícone específico na sua dica de ferramenta.",
...
|cff00ff00Essas informações serão exibidas na tela de informações do seu personagem.|r]=],
	...
	["GEN_WARNING_CHAT_DISABLED"] = "O bate-papo está desativado. Não é possível trocar perfis com outros jogadores até que ele seja ativado novamente.",
	...
	["LAUNCHER_ACTION_DIRECTORY"] = "Abrir página do diretório",
	["LAUNCHER_ACTION_OPEN"] = "Alternar janela principal",
	["LAUNCHER_ACTION_PLAYER"] = "Abrir página do perfil atual",
	["LAUNCHER_ACTION_PROFILES"] = "Abrir página de perfis",
	["LAUNCHER_ACTION_SETTINGS"] = "Abrir página de ajustes",
	["LAUNCHER_ACTION_STATUS"] = "Alternar Status de Roleplay",
	["LAUNCHER_ACTION_TOOLBAR"] = "Alternar barra de ferramentas",
	["LAUNCHER_CONFIG_ACTIONS"] = "Ações do iniciador",
	["LAUNCHER_CONFIG_ADDON_COMPARTMENT"] = "Compartimento adicionais",
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON"] = "Botão de Travar o minimapa",
	["LAUNCHER_CONFIG_LOCK_MINIMAP_BUTTON_HELP"] = "Se marcada, impede que o botão do minimapa seja arrastável.",
	["LAUNCHER_CONFIG_MENU_TITLE"] = "Botão do minimapa.",
	["LAUNCHER_CONFIG_PAGE_DESCRIPTION"] = "As configurações nesta página controlam o comportamento de vários widgets que fornecem acesso à interface do Total RP 3, como botões do minimapa.",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON"] = "Redefinir posição do botão do minimapa",
	["LAUNCHER_CONFIG_RESET_MINIMAP_BUTTON_HELP"] = "Redefine a posição do botão do minimapa para o local padrão.",
	["LAUNCHER_CONFIG_SHOW_ADDON_COMPARTMENT_BUTTON"] = "Mostrar no compartimento de complementos",
	["LAUNCHER_CONFIG_SHOW_ADDON_COMPARTMENT_BUTTON_HELP"] = "Se marcado, exiba uma entrada para RP Total 3 no menu do compartimento de complementos do Blizzard, localizado próximo ao minimapa.|n|nEste recurso não tem efeito no Classic.",
	["LAUNCHER_MODULE_DESCRIPTION"] = "Fornece elementos de interface do usuário, como um botão de minimapa para controlar o complemento.",
	["LAUNCHER_MODULE_NAME"] = "Lançador",
	["MACRO_RPSTATUS_INVALID"] = "Status de interpretação desconhecido: %s",
	...
	["MAP_SCAN_CHAR_GUILD_ONLY"] = "Procure membros da guilda",
	["MAP_SCAN_CHAR_GUILD_ONLY_TITLE"] = "Guilda",
...
Tem certeza que quer visualizar este perfil?]=],
	...
	["MO_SCRIPT_ERROR"] = "Este módulo encontrou um erro fatal de script.",
...
{col:f2bf1a}{link*https://www.curseforge.com/wow/addons/total-rp-3-unit-frames*Faça download no CurseForge}{/col}]=],
	...
	["NAMEPLATES_CONFIG_CUSTOMIZE_GUILD"] = "Mostrar nomes de guildas personalizados",
	["NAMEPLATES_CONFIG_CUSTOMIZE_GUILD_HELP"] = "Se marcada, mostre nomes de guildas personalizados em placas de identificação que os suportem.",
	...
	["NAMEPLATES_CONFIG_CUSTOMIZE_NON_ROLEPLAY_UNITS"] = "Personalize unidades que não sejam de RPG",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NON_ROLEPLAY_UNITS_HELP"] = "Controla a personalização de unidades que não possuem perfis de interpretação.",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NPC_UNITS"] = "Customizar unidades NPC",
	["NAMEPLATES_CONFIG_CUSTOMIZE_NPC_UNITS_HELP"] = "Controla a customização de unidades NPC.",
	["NAMEPLATES_CONFIG_CUSTOMIZE_OOC_UNITS"] = "Customizar unidades OOC",
	["NAMEPLATES_CONFIG_CUSTOMIZE_OOC_UNITS_HELP"] = "Controla a personalização de unidades fora do personagem.",
	...
	["NAMEPLATES_CONFIG_DISABLE_IN_INSTANCES"] = "Desabilitar personalizações em instâncias",
	["NAMEPLATES_CONFIG_DISABLE_IN_INSTANCES_HELP"] = "Se marcada, desabilita as personalizações de placas de identificação em instâncias.|n|nEm conteúdo instanciado, placas de identificação amigáveis ​​não podem ser personalizadas.",
	...
	["NAMEPLATES_CONFIG_MAX_GUILD_NAME_CHARS"] = "Comprimento máximo do nome da guilda",
	["NAMEPLATES_CONFIG_MAX_GUILD_NAME_CHARS_HELP"] = "O número máximo de caracteres a serem exibidos para nomes de guildas. Nomes de guildas que excederem esse tamanho serão cortados.",
	["NAMEPLATES_CONFIG_MAX_NAME_CHARS"] = "Comprimento máximo do nome",
	["NAMEPLATES_CONFIG_MAX_NAME_CHARS_HELP"] = "O número máximo de caracteres a serem exibidos para nomes e títulos de prefixos. Nomes que excederem esse comprimento serão cortados.",
	["NAMEPLATES_CONFIG_MAX_TITLE_CHARS"] = "Comprimento máximo do título",
	["NAMEPLATES_CONFIG_MAX_TITLE_CHARS_HELP"] = "O número máximo de caracteres a serem exibidos em títulos completos. Títulos que excederem esse comprimento serão cortados.",
	["NAMEPLATES_CONFIG_PAGE_HELP"] = "Por favor note que apenas as placas de nome da |cff449fe0Blizzard|r, |cff9966ffKui|r, |cffa8deffPlater|r e |cffc69b6dPlatynator|r são atualmente suportadas. Consulte a dica de ajuda em cada configuração abaixo para informações adicionais.",
	["NAMEPLATES_CONFIG_PAGE_SETTINGS_MAY_REQUIRE_TOGGLE_HELP"] = "Pode ser necessário alternar suas placas de identificação para que as alterações nas configurações tenham efeito.",
	["NAMEPLATES_CONFIG_PAGE_TEXT"] = "Configurações das placas de nome",
	["NAMEPLATES_CONFIG_SHOW_TARGET_UNIT"] = "Sempre mostrar a unidade de destino",
	["NAMEPLATES_CONFIG_SHOW_TARGET_UNIT_HELP"] = "Se marcada, seu alvo atual sempre terá sua placa de identificação visível.",
	["NAMEPLATES_CONFIG_UNIT_NAME_FIRST"] = "Mostrar primeiro nome",
	["NAMEPLATES_CONFIG_UNIT_NAME_FIRST_HELP"] = "Mostrar apenas os primeiros nomes dos jogadores em vez dos nomes completos.|n|nIsso não funcionará com unidades de companhia e perfis recebidos de outros complementos de RPG.",
	["NAMEPLATES_CONFIG_UNIT_NAME_FULL"] = "Mostrar nome completo ",
	["NAMEPLATES_CONFIG_UNIT_NAME_FULL_HELP"] = "Mostrar nome completo das unidades.",
	["NAMEPLATES_CONFIG_UNIT_NAME_ORIGINAL"] = "Mostrar nome original",
	["NAMEPLATES_CONFIG_UNIT_NAME_ORIGINAL_HELP"] = "Mostra o nome original do jogador não modificado da unidade.",
	["NAMEPLATES_CONFIG_UNIT_STATE_DISABLE"] = "Não customize",
	["NAMEPLATES_CONFIG_UNIT_STATE_DISABLE_HELP"] = "Ignore as placas de identificação dessas unidades e não as personalize.",
	["NAMEPLATES_CONFIG_UNIT_STATE_HIDE"] = "Sempre esconder",
	["NAMEPLATES_CONFIG_UNIT_STATE_HIDE_HELP"] = "Sempre esconda as placas de identificação dessas unidades.",
	["NAMEPLATES_CONFIG_UNIT_STATE_SHOW_HELP"] = "Exibir placas de identificação para essas unidades com personalizações completas aplicadas.|n|nA visibilidade dessas placas de identificação pode ser substituída por outras configurações.",
...
Você também pode deixar este campo vazio para criar emotes sem um nome de NPC.]=],
	...
	["PLATER_NAMEPLATES_MODULE_DESCRIPTION"] = "Permite a personalização das placas de identificação do Plater.",
	["PLATER_NAMEPLATES_MODULE_NAME"] = "placa de identificação do Plater.",
	["PLATER_NAMEPLATES_WARN_MOD_IMPORT_ERROR"] = "Ocorreu um erro ao importar o mod Plater.",
	["PLATER_NAMEPLATES_WARN_OUTDATED_MODULE"] = "|cffa8deffPlater|r Placas de identificação estão desatualizadas.",
...
Máximo: 20 kB]=],
	...
	["PR_IMPORT_ERROR"] = "falha ao importar o perfil: %s",
	["PR_IMPORT_ERROR_DECOMPRESS"] = "falha ao descompactar  dados  PEM",
	["PR_IMPORT_ERROR_DESERIALIZE_ACE"] = "falha ao desfazer serial  de dados Ace",
	["PR_IMPORT_ERROR_DESERIALIZE_CBOR"] = "falha ao desfazer serial  de dados CBOR",
	["PR_IMPORT_ERROR_PEM_DECODE"] = "falha ao decodificar  bloco PEM",
	["PR_IMPORT_ERROR_PEM_LABEL"] = "O bloco PEM tem um cabeçalho inválido.",
...
Substituir todo o conteúdo do perfil %s por estes dados importados?]=],
	...
	["REG_COLOR_SWATCH_WARNING"] = "A |cnWARNING_FONT_COLOR:cor do texto foi ajustada|r para melhorar o contraste automaticamente em relação ao fundo da página.|n|nEsta |cnGREEN_FONT_COLOR:amostra a cor pretendida|r escolhida pelo autor do perfil sem ajustes.",
	...
	["REG_COMPANION_ICON"] = "Ícone do companheiro",
	["REG_COMPANION_ICON_TT"] = "Escolha um ícone que irá representar seu ajudante",
	...
	["REG_COMPANION_NAME_COLOR_TT"] = "Cor do nome do seu/s ajudante/s.",
...
Estas ferramentas também permitem que você insira |cffffff00imagens, ícones ou links para websites externos|r.]=],
	...
	["REG_COMPANION_TF_PROFILE_SPEECH"] = "Discurso do ajudante",
	["REG_COMPANION_TF_PROFILE_SPEECH_TT"] = "Abra a janela de fala do NPC com o nome do seu companheiro preenchido.",
...
|cff00ff00%s|r]=],
	["REG_LIST_CHAR_TUTO_FILTER"] = "Esses filtros se aplicam à lista de perfis de personagens acima. O filtro |cnGREEN_FONT_COLOR:name filter|r filtrará a lista de perfis de personagens pelo nome (IC ou OOC) que você inserir. O filtro |cnGREEN_FONT_COLOR:guild filter|r filtrará a lista de perfis de personagens pelo nome da guilda OOC que você inserir. O filtro |cnGREEN_FONT_COLOR:realm only filter|r filtrará a lista de perfis de personagens para mostrar apenas perfis do seu reino atual. O filtro |cnGREEN_FONT_COLOR:note only filter|r filtrará a lista de perfis de personagens para mostrar apenas perfis com notas anexadas",
...
Por exemplo, ele pode ser |c0000ff00esbelto, gordo ou musculoso...|r. Ou ele pode simplesmente ser comum !]=],
	...
	["SLASH_CMD_SET_HELP"] = "Altera o valor associado a um campo do seu perfil atual.",
	["SLASH_CMD_SET_HELP_ARG1"] = "<Campo>",
	["SLASH_CMD_SET_HELP_ARG2"] = "[macro condicionais]",
	["SLASH_CMD_SET_HELP_ARG3"] = "<dados...>",
	["SLASH_CMD_SET_HELP_EXAMPLE1"] = "Sonhando acordado com borboletas",
	["SLASH_CMD_SET_HELP_EXAMPLE2"] = "Urso Feliz; Elfo Zangado",
	["SLASH_CMD_SET_SUCCESS"] = "O campo %1$q do seu perfil atual foi atualizado com sucesso.",
...
|cffff7700Você pode inserir abaixo o motivo. Isso é uma nota pessoal, não será visível aos outros e servirá como lembrete.|r]=],
	...
	["TF_IGNORE_TT"] = "Oculte o perfil deste personagem e não compartilhe mais seu perfil ou localização no mapa com eles.",
...
{col:ffffff}Agradecimentos a Horionne por nos enviar a revista Gamer Culte Online #14 com um artigo sobre o Total RP.{/col}]=],
	...
	["TT_ELVUI_SKIN_ENABLE_TOOLBAR_FRAME"] = "Tema do Quadro da barra de ferramentas",
	...
	["UI_FILTER"] = "Filtrar",
	["UI_FILTER_NO_RESULTS_FOUND_TEXT"] = "Tente ajustar seu critério de pesquisa.",
	...
	["UI_ICON_COPYNAME"] = "Copiar nome do ícone",
	["UI_ICON_OPENBROWSER"] = "Abrir navegador de ícones",
	["UI_ICON_OPTIONS"] = "Mostrar opções de ícone",
	["UI_ICON_PASTE"] = "colocar o ícone",
...
O Total RP não é responsável por links que levem a conteúdo nocivo.
	...
	["URL_COPY_INSTRUCTIONS"] = "Pressione |cnGREEN_FONT_COLOR:%1$s|r Para copiar o link selecionado, e então colar no navegador com |cnGREEN_FONT_COLOR:%2$s|r.",
	["URL_COPY_TITLE"] = "Copiar Link",
	["URL_COPY_WARNING"] = "|cnWARNING_FONT_COLOR: Total RP não é responsável pelo conteúdo dos links externos. "
};

TRP3.loc:RegisterNewLocale("ptBR", "Português", L);
