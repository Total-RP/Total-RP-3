...
|cff00ff00Utiliza el mismo comando de nuevo (|cff999999/trp3 stash|cff00ff00) para restaurar la información.|r]=],
	...
	["DB_STATUS_RP_IC_TT"] = "Esta selección mostrará a los otros jugadores que estás dentro de personaje y tus acciones se considerarán como tal.",
...
TRP3.loc:RegisterNewLocale("esES", "Español (EU)", L);
