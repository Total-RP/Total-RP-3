...
- Fixed an issue with profiles showing as Unknown in the directory quick entries if the profile was received for the first time.
	...
	NAMEPLATES_CONFIG_DISABLE_IN_INSTANCES_HELP = "If checked, disables nameplate customizations while in instances.|n|nIn instanced content friendly nameplates cannot be customized. Disabling this setting will only impact customizations of enemy nameplates.",
