...
TRP3_InterfaceIcons = {
	...
	MiscInfoGuildRank      = { "achievement_guildperk_honorablemention_rank2", "achievement_pvp_o_04", "inv_jewelry_trinketpvp_01" },
	...
	TraitLawful        = { "ability_paladin_sanctifiedwrath", "spell_holy_righteousfury" },
