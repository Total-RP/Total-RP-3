...
TRP3_API.loc = {
	...
	REG_PLAYER_PSYCHO_COLOR_HEADER = "Trait Color",
	REG_PLAYER_PSYCHO_COLOR_SELECT = "Change Trait Color",
	REG_PLAYER_PSYCHO_COLOR_RESET = "Reset Trait Color",
