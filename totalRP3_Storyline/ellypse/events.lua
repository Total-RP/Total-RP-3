...
function Storyline_API.initEventsStructure()
	...
	-- TODO Refresh rewards frame when receiving quest item data
	registerHandler("QUEST_ITEM_UPDATE", function()
		if QuestFrameDetailPanel:IsShown() or QuestFrameProgressPanel:IsShown() then
			-- Refresh objectives
